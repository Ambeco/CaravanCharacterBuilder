...
export const skillAthletics: RankOption = new RankOption("Athletics", skillCategory, cloneArray(skillRanks),
...
export const skillBrawl: RankOption = new RankOption("Brawl", skillCategory, cloneArray(skillRanks),
...
export const skillCraft: RankOption = new RankOption("Craft", skillCategory, cloneArray(skillRanks),
...
export const skillDeception: RankOption = new RankOption("Deception", skillCategory, cloneArray(skillRanks),
...
export const skillDiscipline: RankOption = new RankOption("Discipline", skillCategory, cloneArray(skillRanks),
...
export const skillIntimidate: RankOption = new RankOption("Intimidate", skillCategory, cloneArray(skillRanks),
...
export const skillInsight: RankOption = new RankOption("Insight", skillCategory, cloneArray(skillRanks),
...
export const skillInvestigation: RankOption = new RankOption("Investigation", skillCategory, cloneArray(skillRanks),
...
export const skillKnowledge: RankOption = new RankOption("Knowledge", skillCategory, cloneArray(skillRanks),
...
export const skillLeadership: RankOption = new RankOption("Leadership", skillCategory, cloneArray(skillRanks),
...
export const skillMedicine: RankOption = new RankOption("Medicine", skillCategory, cloneArray(skillRanks),
...
export const skillMelee: RankOption = new RankOption("Melee", skillCategory, cloneArray(skillRanks),
...
export const skillPerception: RankOption = new RankOption("Perception", skillCategory, cloneArray(skillRanks),
...
export const skillPerform: RankOption = new RankOption("Perform", skillCategory, cloneArray(skillRanks),
...
export const skillPersuasion: RankOption = new RankOption("Persuasion", skillCategory, cloneArray(skillRanks),
...
export const skillRanged: RankOption = new RankOption("Ranged", skillCategory, cloneArray(skillRanks),
...
export const skillSkulduggery: RankOption = new RankOption("Skulduggery", skillCategory, cloneArray(skillRanks),
...
export const skillSpellcasting: RankOption = new RankOption("Spellcasting", skillCategory, cloneArray(skillRanks),
...
export const skillStealth: RankOption = new RankOption("Stealth", skillCategory, cloneArray(skillRanks),
...
export const skillSurvival: RankOption = new RankOption("Survival", skillCategory, cloneArray(skillRanks),
...
export const skillTechnology: RankOption = new RankOption("Technology", skillCategory, cloneArray(skillRanks),
...
export const skillWeapon: RankOption = new RankOption("Weapon", skillCategory, cloneArray(skillRanks), "The skill for the weapon in use.")

export const psuedoSkills: RankOption[] = skills.slice(0).concat(skillWeapon);

export function skillByName(name: string): RankOption | undefined {
