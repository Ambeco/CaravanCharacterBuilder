...
export const augmentSetConmanSilverTongued: Set<Augment> = new Set<Augment>([
...
export const specializationConman: RankOption = new RankOption("Conman", specializationCategory,
    [
        new Rank(1, "Silver Tongued", "Your mastery of language allows you to achieve results using methods seemingly in direct opposition. Using innuendos, fast talk and misdirection, you may automatically convince someone of a lie or tall tale. Most people will begin to catch on if this trick is used multiple times in succession. In addition, you can now use Subterfuge instead of Presence when using [Inspire] Abilities2: Cold Read - The first time you make a deception, persuasion, or leadership roll against a target unfamiliar with you, you roll 2 extra dice. In addition, you gain a new augment that can be applied to any [Inspire] ability.", null, augmentSetConmanSilverTongued),
        new Rank(2, "Double Entendre", "When using [Inspire] abilities you can choose to have the augments applied to them to have the reverse effect where possible. Also, you can now use either deception or leadership when using [Inspire] abilities.", null, null),
    ],
    "[Inspire]");

export const specializationBrawn: RankOption = new RankOption("Brawn", specializationCategory,
    [
        new Rank(1, "Beast", "Your carrying capacity is now 7 + 4x Brawn. In addition, The lowest result you can get on a Brawn roll is 1 success.", null, null),
        new Rank(2, "Tough", "You gain +1 titan soak. Your health multiplier is increased by 1. Your HP is increased by 1.", null, null),
        new Rank(3, "Tough as Nails", "You take half damage from all sources.  When calculating damage, this benefit always applies last.", null, null),
    ],
    "Brawn");

export const specializationDexterity: RankOption = new RankOption("Dexterity", specializationCategory,
    [
        new Rank(1, "Pickpocket", "If you spend a minute with someone, through sleight of hand and misdirection you can always remove one item from their possession without anyone noticing.", null, null),
        new Rank(2, "Rapid Reactions", "When you use the Dodge or Parry ability, you may choose to spend extra AP for automatic successes.  Each extra AP spent counts as two automatic successes. You gain +1 AP each round that can only be spent on [Out-of-Turn] abilities.", null, null),
        new Rank(3, "Finesse", "You may use your dexterity instead of brawn for purposes of determining damage of attacks that let you add your brawn. In addition, you may take an unlimited number of [Out-of-Turn] actions each round. You must still follow the limitations each ability may have for itself.", null, null),
    ],
    "Dexterity");
...
export const specializationPresence: RankOption = new RankOption("Presence", specializationCategory,
    [
        ...
        new Rank(2, "Loved", "Creatures like you one step higher than they would normally. (Mortal Enemies -> Hated -> Disliked -> Neutral -> Liked -> Loved -> Obsessed) This simply denotes a starting level. Your actions may influence this in either direction like normal.", null, null),
...
export const specializationSubterfuge: RankOption = new RankOption("Subterfuge", specializationCategory,
    [
        new Rank(1, "Mental Fog", "Your mind cannot be read unless you want it to.", null, null),
        new Rank(2, "Mystical Fog", "You, and all equipment you carry with you, can no longer be detected or scryed through magical means. (For example, a spell or ability that detects the presence of all living creatures within a certain distance.)", null, null),
        new Rank(3, "Manipulator’s Fog", "Creatures will not target you with harmful actions or abilities unless there is no other option.  You may be included in area effect abilities, but when determining targets a creature will ignore you.", null, null),
    ],
    "Subterfuge");

export const specializationSenses: RankOption = new RankOption("Senses", specializationCategory,
    [
        new Rank(1, "Insight", "You always know when people are lying or being misleading.", null, null),
        new Rank(2, "Truesight", "Nothing can hide from you. Within 60’ you can see invisible creatures as if they were visible, and illusions appear translucent. If you already have Truesight, the range is increased to be unlimited.", null, null),
...
export const specializationIntellect: RankOption = new RankOption("Intellect", specializationCategory,
    [
        new Rank(1, "Eidetic Memory", "You can clearly and accurately recall specific details from any event you witnessed.", null, null),
        new Rank(2, "Quick Learner", "The experience cost to purchase new abilities is reduced by 1.", null, null),
        new Rank(3, "Perfected Technique", "The difficulty of any ability you use is reduced by 1.", null, null),
    ],
    "Intellect");
