...
export const abilityParry: Ability = new Ability("Parry",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeDexterity, skillMelee),
    6,
    0,
...
export const abilityDodge: Ability = new Ability("Dodge",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeDexterity, skillAthletics),
    7,
    0,
    ...
    "Unlimited");
export const abilityScathe: Ability = new Ability("Scathe",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    null,
    0,
    1,
    ...
    "Unlimited");
export const abilitySizeUp: Ability = new Ability("Size Up",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    null,
    0,
    1,
    ...
    "Unlimited");
export const abilityRapidFire: Ability = new Ability("Rapid Fire",
    null,
    null,
    new Cost(0, currencyAp),
    [],
    null,
    0,
    1,
    ...
    "Usable once per day");
export const abilityRage: Ability = new Ability("Rage",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    new Roll(attributeBrawn, skillIntimidate),
    6,
    3,
    "Self",
    ...
    "Unlimited");
export const abilityLastStand: Ability = new Ability("Last Stand",
    null,
    null,
    new Cost(2, currencyAp),
    [],
...
export const abilityConfidence: Ability = new Ability("Confidence",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited usage. You may only have one [Stance] ability active at a time.");
export const ability_Duel: Ability = new Ability(" Duel",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited usage. You may only have one [Stance] ability active at a time.");
export const abilityLoneWolf: Ability = new Ability("Lone Wolf",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited usage. You may only have one [Stance] ability active at a time.");
export const abilityBasicConjuration: Ability = new Ability("Basic Conjuration",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityAdvancedConjuration: Ability = new Ability("Advanced Conjuration",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    null,
    0,
    1,
    ...
    "Unlimited");
export const abilityTeleport: Ability = new Ability("Teleport",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityAnchor: Ability = new Ability("Anchor",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityCreateLife: Ability = new Ability("Create Life",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityBloodfiend: Ability = new Ability("Bloodfiend",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityAura: Ability = new Ability("Aura",
    null,
    null,
    new Cost(0, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityTranscendence: Ability = new Ability("Transcendence",
    null,
    null,
    new Cost(7, currencyAp),
    [],
    new Roll(attributePresence, skillSpellcasting),
    8,
    5,
    "Self",
...
export const abilityRetractableClaws: Ability = new Ability("Retractable Claws",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeDexterity, skillBrawl),
    6,
    1,
    ...
    "Unlimited");
export const abilityRetractableFangs: Ability = new Ability("Retractable Fangs",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityShapeshifting: Ability = new Ability("Shapeshifting",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityAnimalCompanion: Ability = new Ability("Animal Companion",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "");
export const abilityMimicry: Ability = new Ability("Mimicry",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    new Roll(attributeSenses, skillInsight),
    7,
    0,
    "N/A",
...
export const abilityPlantBeast: Ability = new Ability("Plant Beast",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityKiBlast: Ability = new Ability("Ki Blast",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    new Roll(attributeSenses, skillDiscipline),
    6,
    1,
    "One creature within 60’",
    "6 force damage",
    "Unlimited");
export const abilityUnlockTheSeals: Ability = new Ability("Unlock the Seals",
    null,
    null,
    new Cost(0, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityKiEruption: Ability = new Ability("Ki Eruption",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "6 force damage",
    "Unlimited");
export const abilityMeditate: Ability = new Ability("Meditate",
    null,
    null,
    new Cost(7, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityCentered: Ability = new Ability("Centered",
    null,
    null,
    new Cost(7, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityTriage: Ability = new Ability("Triage",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityMend: Ability = new Ability("Mend",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityCure: Ability = new Ability("Cure",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityGreaterHeal: Ability = new Ability("Greater Heal",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityPurify: Ability = new Ability("Purify",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilitySanctify: Ability = new Ability("Sanctify",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter.");
export const abilityRevival: Ability = new Ability("Revival",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityMassHeal: Ability = new Ability("Mass Heal",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfWeakening: Ability = new Ability("Song of Weakening",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    new Roll(attributePresence, skillPerform),
    6,
    1,
    ...
    "Usable once per encounter");
export const abilitySongOfHaste: Ability = new Ability("Song of Haste",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfValor: Ability = new Ability("Song of Valor",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfFervor: Ability = new Ability("Song of Fervor",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfProtection: Ability = new Ability("Song of Protection",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfLethargy: Ability = new Ability("Song of Lethargy",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfHeroism: Ability = new Ability("Song of Heroism",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfBravery: Ability = new Ability("Song of Bravery",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfDoom: Ability = new Ability("Song of Doom",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySongOfSongs: Ability = new Ability("Song of Songs",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityInspiration: Ability = new Ability("Inspiration",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityTorment: Ability = new Ability("Torment",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "Usable a number of times per encounter equal to total ranks in [Inspire] specializations.");
export const abilityLookOut_: Ability = new Ability("Look Out!",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityDistraction: Ability = new Ability("Distraction",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    new Roll(attributePresence, skillDeception),
    8,
    0,
    ...
    "Unlimited");
export const abilityCommand: Ability = new Ability("Command",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityTrick: Ability = new Ability("Trick",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityCharge_: Ability = new Ability("Charge!",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributePresence, skillLeadership),
    6,
    2,
    ...
    "Usable once per encounter");
export const abilityStall: Ability = new Ability("Stall",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityAttack_: Ability = new Ability("Attack!",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityInspireDoubt: Ability = new Ability("Inspire Doubt",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityKeepFighting_: Ability = new Ability("Keep Fighting!",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityFalter: Ability = new Ability("Falter",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityStayWithMe_: Ability = new Ability("Stay With Me!",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityRevealWeakness: Ability = new Ability("Reveal Weakness",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySeduce: Ability = new Ability("Seduce",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityDominate: Ability = new Ability("Dominate",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter.");
export const abilityMassSeduce: Ability = new Ability("Mass Seduce",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityMassDominate: Ability = new Ability("Mass Dominate",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter.");
export const abilityTaunt: Ability = new Ability("Taunt",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    new Roll(attributePresence, skillIntimidate),
    6,
    2,
    "One creature within 30’",
    ...
    "Unlimited");
export const abilityIntercept: Ability = new Ability("Intercept",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityFaith: Ability = new Ability("Faith",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySecondWind: Ability = new Ability("Second Wind",
    null,
    null,
    new Cost(0, currencyAp),
    [],
    ...
    "Usable once per encounter.");
export const abilityBrace: Ability = new Ability("Brace",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Usable once per encounter.");
export const abilityAvatarOfDeath: Ability = new Ability("Avatar of Death",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    new Roll(attributeBrawn, skillDiscipline),
    7,
    1,
    "Self",
...
export const abilityQuarry: Ability = new Ability("Quarry",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityAmbush: Ability = new Ability("Ambush",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityDisengage: Ability = new Ability("Disengage",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited.");
export const abilityTakedown: Ability = new Ability("Takedown",
    null,
    null,
    new Cost(5, currencyAp),
    [],
...
export const abilityMarkedForDeath: Ability = new Ability("Marked for Death",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per rest.");
export const abilityAssassinate: Ability = new Ability("Assassinate",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    new Roll(attributeDexterity, skillWeapon),
    6,
    5,
    ...
    "Usable once per encounter. Must be hidden from the target.");
export const abilityDeal: Ability = new Ability("Deal",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    new Roll(attributeSubterfuge, skillPersuasion),
    0,
    1,
    "One creature within 30’",
    ...
    "Usable once per encounter.");
export const abilitySummonImp: Ability = new Ability("Summon Imp",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilitySummonAnnihilator: Ability = new Ability("Summon Annihilator",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilitySummonDreadking: Ability = new Ability("Summon Dreadking",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityDemonForm: Ability = new Ability("Demon Form",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Usable once per rest.");
export const abilityIllusion: Ability = new Ability("Illusion",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    new Roll(attributeSubterfuge, skillSpellcasting),
    6,
    2,
    "A point within 60’",
    ...
    "Unlimited");
export const abilityInvisibility: Ability = new Ability("Invisibility",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityDisguise: Ability = new Ability("Disguise",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityBlur: Ability = new Ability("Blur",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilitySupremeInvisibility: Ability = new Ability("Supreme Invisibility",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilitySimulacrum: Ability = new Ability("Simulacrum",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Usable once per day");
export const abilityFirebolt: Ability = new Ability("Firebolt",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "8 Fire damage",
    "Unlimited");
export const abilityFlamethrower: Ability = new Ability("Flamethrower",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Fire damage",
    "Unlimited");
export const abilityFlameBurst: Ability = new Ability("Flame Burst",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "18 Fire damage",
    "Usable once per encounter");
export const abilityFlameShield: Ability = new Ability("Flame Shield",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityFireball: Ability = new Ability("Fireball",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "20 Fire damage",
    "Usable once per encounter");
export const abilityScorch: Ability = new Ability("Scorch",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "25 Fire damage",
    "Usable once per encounter");
export const abilityMeteorStorm: Ability = new Ability("Meteor Storm",
    null,
    null,
    new Cost(7, currencyAp),
    [],
    ...
    "30 Fire damage",
    "Usable once per day");
export const abilitySplash: Ability = new Ability("Splash",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeSenses, skillSpellcasting),
    6,
    1,
    "One creature within 60’",
    "8 Water damage",
    "Unlimited");
export const abilityGeyser: Ability = new Ability("Geyser",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Water damage.",
    "Unlimited");
export const abilityTorrent: Ability = new Ability("Torrent",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "18 Water damage",
    "Usable once per encounter");
export const abilityCleanse: Ability = new Ability("Cleanse",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityTidalWave: Ability = new Ability("Tidal Wave",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Water damage",
    "Usable once per encounter");
export const abilityCascade: Ability = new Ability("Cascade",
    null,
    null,
    new Cost(7, currencyAp),
    [],
    ...
    "Usable once per Encounter");
export const abilityStoneThrow: Ability = new Ability("Stone Throw",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeBrawn, skillSpellcasting),
    6,
    1,
    "One creature within 60’",
    "8 Earth damage",
    "Unlimited");
export const abilityUpheaval: Ability = new Ability("Upheaval",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Earth damage",
    "Unlimited");
export const abilityCommuneWithTheEarth: Ability = new Ability("Commune with the Earth",
    null,
    null,
    new Cost(10, currencyAp),
    [],
    new Roll(attributeBrawn, skillSpellcasting),
    7,
    0,
    ...
    "Usable once per encounter");
export const abilityEarthenGrasp: Ability = new Ability("Earthen Grasp",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityGrowth: Ability = new Ability("Growth",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityStonewall: Ability = new Ability("Stonewall",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityFissure: Ability = new Ability("Fissure",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityBoulderToss: Ability = new Ability("Boulder toss",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "25 Earth damage",
    "Usable once per encounter");
export const abilityStoneskin: Ability = new Ability("Stoneskin",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilitySlice: Ability = new Ability("Slice",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "8 Air damage",
    "Unlimited");
export const abilityGustOfWind: Ability = new Ability("Gust of Wind",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Air damage",
    "Unlimited");
export const abilityGuideTheWind: Ability = new Ability("Guide the Wind",
    null,
    null,
    new Cost(10, currencyAp),
    [],
    ...
    "Usable once per day");
export const abilityDownburst: Ability = new Ability("Downburst",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "18 Air damage",
    "Usable once per encounter");
export const abilityClearTheAir: Ability = new Ability("Clear the Air",
    null,
    null,
    new Cost(4, currencyAp),
    [],
    new Roll(attributeSubterfuge, skillSpellcasting),
    7,
    3,
    ...
    "Usable once per encounter");
export const abilityWindScar: Ability = new Ability("Wind scar",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "23 Air damage",
    "Usable once per encounter");
export const abilitySuffocate: Ability = new Ability("Suffocate",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityTornado: Ability = new Ability("Tornado",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per day");
export const abilityShock: Ability = new Ability("Shock",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeDexterity, skillSpellcasting),
    6,
    1,
    "One creature within 60’",
    "8 Lightning damage",
    "Unlimited");
export const abilityDischarge: Ability = new Ability("Discharge",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Lightning damage.",
    "Unlimited");
export const abilityLightningBolt: Ability = new Ability("Lightning Bolt",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "12 Lightning damage",
    "Usable once per encounter");
export const abilityChainLightning: Ability = new Ability("Chain Lightning",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityIonize: Ability = new Ability("Ionize",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "25 Lightning damage",
    "Usable once per encounter");
export const abilityIceSpike: Ability = new Ability("Ice Spike",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeIntellect, skillSpellcasting),
    6,
    1,
    "One creature within 60’",
    "8 Cold damage",
    "Unlimited");
export const abilityConeOfCold: Ability = new Ability("Cone of Cold",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Cold damage",
    "Unlimited");
export const abilityIceBlock: Ability = new Ability("Ice Block",
    null,
    null,
    new Cost(0, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityPermafrost: Ability = new Ability("Permafrost",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityCurseOfCold: Ability = new Ability("Curse of Cold",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityHoarfrost: Ability = new Ability("Hoarfrost",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "20 cold damage",
    "Usable once per encounter");
export const abilityHypothermia: Ability = new Ability("Hypothermia",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityEnergyDart: Ability = new Ability("Energy Dart",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "6 Force damage",
    "Unlimited");
export const abilityBarrage: Ability = new Ability("Barrage",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityArcaneExplosion: Ability = new Ability("Arcane Explosion",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "14 Force damage",
    "Usable once per encounter");
export const abilityMageArmor: Ability = new Ability("Mage Armor",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityForceHammer: Ability = new Ability("Force Hammer",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "20 Force damage",
    "Usable once per encounter");
export const abilityPoisonSpray: Ability = new Ability("Poison Spray",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "9 Poison damage",
    "Unlimited");
export const abilityPoisonSpit: Ability = new Ability("Poison Spit",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    new Roll(attributeDexterity, skillRanged),
    6,
    1,
    "One creature within 60’",
    "Deals 8 poison damage",
    "Unlimited");
export const abilityEnvenomedWeapons: Ability = new Ability("Envenomed Weapons",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityToxicBurst: Ability = new Ability("Toxic burst",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Poison damage.",
    "Unlimited");
export const abilityPoisonCloud: Ability = new Ability("Poison Cloud",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityPoisonWave: Ability = new Ability("Poison Wave",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Poison damage",
    "Usable once per encounter");
export const abilityVilePoison: Ability = new Ability("Vile Poison",
    null,
    null,
    new Cost(7, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityAcidThrow: Ability = new Ability("Acid Throw",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "9 Acid damage",
    "Unlimited");
export const abilityAcidSpit: Ability = new Ability("Acid Spit",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "Deals 8 Acid damage",
    "Unlimited");
export const abilityAcidSpray: Ability = new Ability("Acid Spray",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Acid damage",
    "Unlimited");
export const abilityAcidFog: Ability = new Ability("Acid Fog",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityEatAway: Ability = new Ability("Eat Away",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "20 Acid damage",
    "Usable once per encounter");
export const abilityDisintegrate: Ability = new Ability("Disintegrate",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "23 Acid damage ",
    "Usable once per encounter");
export const abilityAcidBlood: Ability = new Ability("Acid Blood",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityDecay: Ability = new Ability("Decay",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "8 Necrotic damage",
    "Unlimited");
export const abilityRaiseZombie: Ability = new Ability("Raise Zombie",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited, following standard companion limit.");
export const abilityRaiseSkeleton: Ability = new Ability("Raise Skeleton",
    null,
    null,
    new Cost(10, currencyAp),
    [],
    ...
    "You raise a corpse to do your bidding as one of your companions.",
    "Unlimited, following standard companion limit.");
export const abilityRaiseGhost: Ability = new Ability("Raise Ghost",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "Unlimited, following standard companion limit.");
export const abilityRaiseGhast: Ability = new Ability("Raise Ghast",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "You raise a corpse to do your bidding as one of your companions.",
    "Unlimited, following standard companion limit.");
export const abilityBreathOfDeath: Ability = new Ability("Breath of Death",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "8 Necrotic damage",
    "Unlimited");
export const abilityDefile: Ability = new Ability("Defile",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityRaiseWight: Ability = new Ability("Raise Wight",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "You raise a corpse to do your bidding as one of your companions.",
    "Unlimited, following standard companion limit.");
export const abilityRaiseWraith: Ability = new Ability("Raise Wraith",
    null,
    null,
    new Cost(1, currencyAp),
    [],
    ...
    "You raise a soul to do your bidding as one of your companions.",
    "Unlimited, following standard companion limit.");
export const abilityDeathKnell: Ability = new Ability("Death knell",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "16 Necrotic damage",
    "Usable once per encounter");
export const abilityBanshee_sWail: Ability = new Ability("Banshee’s Wail",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityDeath: Ability = new Ability("Death",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "25 necrotic damage",
    "Usable once per encounter");
export const abilityRaiseDeathKnight: Ability = new Ability("Raise Death Knight",
    null,
    null,
    new Cost(8, currencyAp),
    [],
    null,
    0,
    1,
...
export const abilityPlague: Ability = new Ability("Plague",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "",
    "Usable once per encounter");
export const abilityReaper_sTouch: Ability = new Ability("Reaper’s Touch",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityBeam: Ability = new Ability("Beam",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "8 Radiant damage",
    "Unlimited");
export const abilityStarburst: Ability = new Ability("Starburst",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityCensure: Ability = new Ability("Censure",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Usable once per encounter");
export const abilityShadowbolt: Ability = new Ability("Shadowbolt",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "8 Shadow damage",
    "Unlimited");
export const abilityShadowFog: Ability = new Ability("Shadow Fog",
    null,
    null,
    new Cost(5, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityShadowstep: Ability = new Ability("Shadowstep",
    null,
    null,
    new Cost(2, currencyAp),
    [],
...
export const abilityNightmareFiend: Ability = new Ability("Nightmare Fiend",
    null,
    null,
    new Cost(1, currencyAp),
    [],
...
export const abilityMindMelt: Ability = new Ability("Mind Melt",
    null,
    null,
    new Cost(3, currencyAp),
    [],
    ...
    "8 Psychic damage",
    "Unlimited");
export const abilityPsiTools: Ability = new Ability("Psi Tools",
    null,
    null,
    new Cost(2, currencyAp),
    [],
    ...
    "Unlimited");
export const abilityPsiBlades: Ability = new Ability("Psi Blades",
    null,
    null,
    new Cost(2, currencyAp),
    [],
...
export const abilities: Ability[] = [
    ...
    abilityRetractableClaws,
    abilityRetractableFangs,
    abilityShapeshifting,
    abilityAnimalCompanion,
    abilityMimicry,
    abilityPlantBeast,
    abilityKiBlast,
