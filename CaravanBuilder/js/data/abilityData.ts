...
export const abilityParry: BaseAbility = new BaseAbility("Parry",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityScathe: BaseAbility = new BaseAbility("Scathe",
    null,
    null,
    new Cost(2, Currency.getCurrency("ap")),
    [],
    null,
    0,
    1,
...
export const abilitySizeUp: BaseAbility = new BaseAbility("Size Up",
    null,
    null,
    new Cost(1, Currency.getCurrency("ap")),
    [],
    null,
    0,
    1,
    ...
    "Unlimited");
export const abilityRapidFire: BaseAbility = new BaseAbility("Rapid Fire",
    null,
    null,
    new Cost(0, Currency.getCurrency("ap")),
    [],
    null,
    0,
    1,
...
export const abilityConfidence: BaseAbility = new BaseAbility("Confidence",
    ...
    "Unlimited usage. You may only have one [Stance] ability active at a time.");
export const ability_Duel: BaseAbility = new BaseAbility(" Duel",
    null,
    null,
    new Cost(2, Currency.getCurrency("ap")),
    [],
    ...
    "Unlimited usage. You may only have one [Stance] ability active at a time.");
export const abilityLoneWolf: BaseAbility = new BaseAbility("Lone Wolf",
    null,
    null,
    new Cost(2, Currency.getCurrency("ap")),
    [],
...
export const abilityAdvancedConjuration: BaseAbility = new BaseAbility("Advanced Conjuration",
    null,
    null,
    new Cost(5, Currency.getCurrency("ap")),
    [],
    null,
    0,
    1,
    ...
    "Unlimited");
export const abilityTeleport: BaseAbility = new BaseAbility("Teleport",
    null,
    null,
    new Cost(1, Currency.getCurrency("ap")),
    [],
    ...
    "Unlimited");
export const abilityAnchor: BaseAbility = new BaseAbility("Anchor",
    null,
    null,
    new Cost(1, Currency.getCurrency("ap")),
    [],
...
export const abilityAura: BaseAbility = new BaseAbility("Aura",
    null,
    null,
    new Cost(0, Currency.getCurrency("ap")),
    [],
...
export const abilityTranscendence: BaseAbility = new BaseAbility("Transcendence",
    null,
    null,
    new Cost(7, Currency.getCurrency("ap")),
    [],
...
export const abilityRetractableClaws: BaseAbility = new BaseAbility("Retractable Claws",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityRetractableFangs: BaseAbility = new BaseAbility("Retractable Fangs",
    ...
    "Unlimited");
export const abilityShapeshifting: BaseAbility = new BaseAbility("Shapeshifting",
    null,
    null,
    new Cost(5, Currency.getCurrency("ap")),
    [],
    ...
    "Unlimited");
export const abilityAnimalCompanion: BaseAbility = new BaseAbility("Animal Companion",
    null,
    null,
    new Cost(1, Currency.getCurrency("ap")),
    [],
    ...
    "");
export const abilityMimicry: BaseAbility = new BaseAbility("Mimicry",
    null,
    null,
    new Cost(5, Currency.getCurrency("ap")),
    [],
...
export const abilityMassDominate: BaseAbility = new BaseAbility("Mass Dominate",
    ...
    "Usable once per encounter.");
export const abilityTaunt: BaseAbility = new BaseAbility("Taunt",
    null,
    null,
    new Cost(2, Currency.getCurrency("ap")),
    [],
    ...
    "Unlimited");
export const abilityIntercept: BaseAbility = new BaseAbility("Intercept",
    null,
    null,
    new Cost(2, Currency.getCurrency("ap")),
    [],
...
export const abilityFaith: BaseAbility = new BaseAbility("Faith",
    ...
    "Usable once per encounter");
export const abilitySecondWind: BaseAbility = new BaseAbility("Second Wind",
    null,
    null,
    new Cost(0, Currency.getCurrency("ap")),
    [],
...
export const abilitySimulacrum: BaseAbility = new BaseAbility("Simulacrum",
    ...
    "Usable once per day");
export const abilityFirebolt: BaseAbility = new BaseAbility("Firebolt",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
    ...
    "8 Fire damage",
    "Unlimited");
export const abilityFlamethrower: BaseAbility = new BaseAbility("Flamethrower",
    null,
    null,
    new Cost(5, Currency.getCurrency("ap")),
    [],
...
export const abilityMeteorStorm: BaseAbility = new BaseAbility("Meteor Storm",
    ...
    "30 Fire damage",
    "Usable once per day");
export const abilitySplash: BaseAbility = new BaseAbility("Splash",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityCommuneWithTheEarth: BaseAbility = new BaseAbility("Commune with the Earth",
    null,
    null,
    new Cost(10, Currency.getCurrency("ap")),
    [],
    new Roll(attributeBrawn, skillSpellcasting),
    7,
    0,
...
export const abilityClearTheAir: BaseAbility = new BaseAbility("Clear the Air",
    null,
    null,
    new Cost(4, Currency.getCurrency("ap")),
    [],
    new Roll(attributeSubterfuge, skillSpellcasting),
    7,
    3,
...
export const abilityIonize: BaseAbility = new BaseAbility("Ionize",
    ...
    "25 Lightning damage",
    "Usable once per encounter");
export const abilityIceSpike: BaseAbility = new BaseAbility("Ice Spike",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityHypothermia: BaseAbility = new BaseAbility("Hypothermia",
    ...
    "Usable once per encounter");
export const abilityEnergyDart: BaseAbility = new BaseAbility("Energy Dart",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityForceHammer: BaseAbility = new BaseAbility("Force Hammer",
    ...
    "20 Force damage",
    "Usable once per encounter");
export const abilityPoisonSpray: BaseAbility = new BaseAbility("Poison Spray",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
    ...
    "9 Poison damage",
    "Unlimited");
export const abilityPoisonSpit: BaseAbility = new BaseAbility("Poison Spit",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
    ...
    "Unlimited");
export const abilityEnvenomedWeapons: BaseAbility = new BaseAbility("Envenomed Weapons",
    null,
    null,
    new Cost(1, Currency.getCurrency("ap")),
    [],
...
export const abilityVilePoison: BaseAbility = new BaseAbility("Vile Poison",
    ...
    "Usable once per encounter");
export const abilityAcidThrow: BaseAbility = new BaseAbility("Acid Throw",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
    ...
    "9 Acid damage",
    "Unlimited");
export const abilityAcidSpit: BaseAbility = new BaseAbility("Acid Spit",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityRaiseDeathKnight: BaseAbility = new BaseAbility("Raise Death Knight",
    null,
    null,
    new Cost(8, Currency.getCurrency("ap")),
    [],
    null,
    0,
    1,
...
export const abilityCensure: BaseAbility = new BaseAbility("Censure",
    ...
    "Usable once per encounter");
export const abilityShadowbolt: BaseAbility = new BaseAbility("Shadowbolt",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
...
export const abilityMindMelt: BaseAbility = new BaseAbility("Mind Melt",
    null,
    null,
    new Cost(3, Currency.getCurrency("ap")),
    [],
