...
let AttunementDescription = "<p>All heroes are attuned in different ways. Certain spheres of power come naturally to you, whereas others might not.</p>"
...
let attunementMartial = new RankOption("Martial", [
    new Rank(8, null, null, new Set()),
    new Rank(7, null, null, new Set()),
    new Rank(6, null, null, new Set()),
    new Rank(5, null, null, new Set()),
    new Rank(4, null, null, new Set()),
    new Rank(3, null, null, new Set()),
]);
let attunementArcane = new RankOption("Arcane", [
    new Rank(8, null, null, new Set()),
    new Rank(7, null, null, new Set()),
    new Rank(6, null, null, new Set()),
    new Rank(5, null, null, new Set()),
...
let attunementDivine = new RankOption("Divine", [
    new Rank(8, null, null, new Set()),
    new Rank(7, null, null, new Set()),
    new Rank(6, null, null, new Set()),
    new Rank(5, null, null, new Set()),
...
let attunementNature = new RankOption("Nature", [
    new Rank(8, null, null, new Set()),
    new Rank(7, null, null, new Set()),
    new Rank(6, null, null, new Set()),
    new Rank(5, null, null, new Set()),
...
let attunementAnimus = new RankOption("Animus", [
    new Rank(8, null, null, new Set()),
    new Rank(7, null, null, new Set()),
    new Rank(6, null, null, new Set()),
    new Rank(5, null, null, new Set()),
...
let attunementAttributes = new RankOption("Attributes", [
    new Rank(4, null, null, new Set()),
    new Rank(3, null, null, new Set()),
]);
let attunementSkills = new RankOption("Skills", [
    new Rank(2, null, null, new Set()),
    new Rank(1, null, null, new Set()),
]);
//# sourceMappingURL=attunementData.js.map