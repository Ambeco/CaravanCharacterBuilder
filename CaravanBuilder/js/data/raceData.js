...
let raceHuman = new Choice("Human", "Humans are the driving force of the world. They are an adaptable race, able to thrive in a wide range of conditions, and you would be hard pressed to go anywhere in the world and not encounter humans.", new Set([
    new SheetFeature("Human Perseverance", "You gain +1 maximum resolve")
]));
let raceElf = new Choice("Elf", "Elves are intelligent and perceptive creatures. They tend to be taller than humans and have large, pointed ears. They are exceptionally swift.", new Set([
    new SheetFeature("Elven Swiftness", "You can perform one move action for 1 less AP on each of your turns.")
]));
let raceDwarf = new Choice("Dwarf", "Dwarves are short and stout. Partially because of their center of gravity being much lower and partially because they are generally stubborn as all hell, dwarves have a hard time being moved.", new Set([
...
let raceOrc = new Choice("Orc", "Orcs are ferocious creatures. Typically taller and larger than humans, they tend to be pretty intimidating. Orcs have green or grey skin color. They are very strong, but tend to be less intelligent than the other races.", new Set([
    new SheetFeature("Orcish Resilience", "You gain +2 hit points")
]));
let raceGolem = new Choice("Golem", "Golems are rather large creatures seemingly made of stone. These creatures were accidentally created when a large arcane ritual went wrong. Golems are a pretty rare sight in the world and, because of their recent existence, they lack the understanding of etiquette that others possess. Regardless, they are immensely strong and surprisingly dexterous.", new Set([
    new SheetFeature("Unbreakable", "+1 titan soak")
]));
let raceGnome = new Choice("Gnome", "Gnomes are very small creatures. They look like short humans. Gnomes, however, are incredibly smart, but their small size makes them lack in strength. They also have a natural resistance to magic.", new Set([
...
let raceErrati = new Choice("Errati", "An uncommon race that resembles large stickbugs. Most errati are subservient to a hivemind social structure, however many of the race are granted autonomy as part of their role in serving the queen and the hive. Some use this freedom to leave the hive forever, but most maintain ties in some regards.", new Set([
...
let raceFlora = new Choice("Flora", "Flora resemble lithe saplings twisted into a humanoid form. Though they have many plant-like qualities, they are more closely related to gnomes than to plants. This includes a basic animal anatomy under their bark-like and leafy exterior.", new Set([
...
let raceImmortal = new Choice("Immortal", "Not a true race, any individual may become immortal. Whether through an accident of fate, divine heritage, or a pact with demonic forces, an immortal is someone blessed (or cursed) to live forever.<b/>An immortal can be killed.A spear through the heart or having their head removed will still result in death.However their body does not age and will naturally live forever.<b/>An immortal looks just like their base race, but gain none of the racial benefits associated with their base race.Instead, they gain the following trait:", new Set([
...
let raceShaitan = new Choice("Shaitan", "The shaitan are descendents of demons.  Though human in appearance normally, they can draw on their demonic bloodline to take on horrific and powerful forms.", new Set([
...
let raceLarva = new Choice("Larva", "Larva have no society of their own. Instead, they mingle among the other races, blending in with their shapeshift ability. They reproduce by budding, which is a process that takes several days and a lot of calories.  But at the end a young child who appears to be 6 or 7 is “born”", new Set([
...
//# sourceMappingURL=raceData.js.map