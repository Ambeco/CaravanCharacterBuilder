...
let skillCategory: OptionCategory = new OptionCategory("Skills", 
...
export let skillAnimals: RankOption = new RankOption("Animal Handling", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillAthletics: RankOption = new RankOption("Athletics", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillBrawl: RankOption = new RankOption("Brawl", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillCraft: RankOption = new RankOption("Craft", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillDeception: RankOption = new RankOption("Deception", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillDiscipline: RankOption = new RankOption("Discipline", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillIntimidate: RankOption = new RankOption("Intimidate", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillInsight: RankOption = new RankOption("Insight", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillInvestigation: RankOption = new RankOption("Investigation ", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillKnowledge: RankOption = new RankOption("Knowledge", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillLeadership: RankOption = new RankOption("Leadership", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillMedicine: RankOption = new RankOption("Medicine", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillMelee: RankOption = new RankOption("Melee", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillPerception: RankOption = new RankOption("Perception", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillPerform: RankOption = new RankOption("Perform", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillPersuasion: RankOption = new RankOption("Persuasion", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillRanged: RankOption = new RankOption("Ranged", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillSkulduggery: RankOption = new RankOption("Skulduggery", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillSpellcasting: RankOption = new RankOption("Spellcasting", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillStealth: RankOption = new RankOption("Stealth", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillSurvival: RankOption = new RankOption("Survival", skillCategory, duplicateRankArray(attunementRanks),
...
export let skillTechnology: RankOption = new RankOption("Technology", skillCategory, duplicateRankArray(attunementRanks),
    "Knowledge of gears, guns, gadgets, and gizmos."
    + "< p > <b>Focus Examples: </b> simple machines, mechanical repair, firearms</p >");

export let skills: RankOption[] = [
    skillAnimals,
    skillAthletics,
    skillBrawl,
    skillCraft,
