...
export const specializationDefender: RankOption = new RankOption("Defender", specializationCategory,
    [
        new Rank(1, "Shield Mastery", "Shields you wear gain +1 damage and the Concussive property. Shields also lose the unwieldy property. In addition, you gain a list of augments that you can apply to the ability, Taunt.", null, augmentSetDefenderShieldMastery),
        ...
        new Rank(3, "True Defender", "Taunt’s range is increased by 30’ and can affect a number of additional creatures equal to your ranks in intimidate. In addition, you gain a list of augments you can apply to the ability, Intercept.", null, augmentSetDefenderTrueDefender),
    ],
    "[Tank]");

export const specializationSentinel: RankOption = new RankOption("Sentinel", specializationCategory,
    [
        new Rank(1, "Aware", "When you are on watch you automatically succeed on all perception rolls. Your initiative score is increased by 2.", null, null),
        new Rank(2, "Astute", "The difficulty of Parry and Dodge is reduced by 1 for you. You may perform any basic sensory action (such as looking for an invisible creature) for no AP once on each of your turns.", null, null),
        new Rank(3, "Sixth Sense", "You gain a blindsense out to 10’ (You know the presence of all creatures out to 10’, even if they are hidden or invisible.) You ignore any penalties gained from creatures being hidden from you, being obscured or being invisible.", null, null),
    ],
    "[Tank]");
...
export const specializationTitan: RankOption = new RankOption("Titan", specializationCategory,
    [
        new Rank(1, "Ultimate Parry", "You no longer need to roll for the ability, Parry. Instead, you automatically succeed and reduce the attack to 0 successes. In addition, you may perform two additional [Out-of-Turn] actions each round.", null, null),
        new Rank(2, "Ultimate Warrior", "You gain +1 titan soak, +1 health multiplier, +1 HP, +1 heal per day and +1 maximum resolve. In addition, you gain a few augments for the ability, Second Wind.", null, augmentSetTitanUltimateWarrior),
        new Rank(3, "Ultimate Titan", "Your unconscious health is tripled. (After all other modifiers). You can spend resolve to heal yourself when unconscious. The healing puts you at 1 health. This does not count as a heal. You gain a few augments for the ability, Avatar of Death.", null, augmentSetTitanUltimateTitan),
    ],
    "[Tank]");

export const specializationBladedancer: RankOption = new RankOption("Bladedancer", specializationCategory,
    [
        new Rank(1, "Graceful", "Your actions no longer can provoke [Out-of-Turn] actions. In addition, your movement speed is increased by 2", null, null),
        new Rank(2, "Heightened Reactions", "You gain +2 AP per round that you may only spend on [Out-of-Turn] abilities. In addition, you can make one additional [Out-of-Turn] action each round.", null, null),
        new Rank(3, "Dancer", "All [Stance] abilities cost 1 less AP for you. In addition, anytime you use a [Stance] ability, you gain 5 temporary health. These hit points cannot stack with themselves.", null, null),
    ],
    "Bladedancer");
...
export const specializationTactician: RankOption = new RankOption("Tactician", specializationCategory,
    [
        new Rank(1, "Basic Maneuvers", "You learn a few new augments that can be applied to any [Weapon] abilities you perform.", null, augmentSetTacticianBasicManeuvers),
        new Rank(2, "Complex Maneuvers", "You learn a few new augments that can be applied to any [Weapon] abilities you perform.", null, augmentSetTacticianComplexManeuvers),
        new Rank(3, "Master Maneuvers", "You learn a few new augments that can be applied to any [Weapon] abilities you perform.", null, augmentSetTacticianMasterManeuvers),
    ],
    "Tactician");
...
export const specializationTempest: RankOption = new RankOption("Tempest", specializationCategory,
    [
        new Rank(1, "Quick Draw", "You may draw up to two weapons on your turn for no AP cost. In addition, if you are wielding two ranged weapons, you can now parry as if you were wielding a melee weapon.", null, null),
        new Rank(2, "Dual Parry", "While wielding two weapons, the AP cost to parry is reduced by 2 (minimum of 1)", null, null),
        new Rank(3, "Dual Wielder", "You deal 3 extra damage with all of your attacks while you are wielding two weapons. In addition, you gain a new augment that can be applied to any [Weapon] ability.", null, augmentSetTempestDualWielder),
    ],
    "Tempest");
...
export const specializationBerserker: RankOption = new RankOption("Berserker", specializationCategory,
    [
        new Rank(1, "Fury", "You learn an assortment of augments that can be used on Rage.", null, augmentSetBerserkerFury),
        new Rank(2, "Tireless Warrior", "You may ignore the penalty of one application of exhaustion. In addition, you gain +2 HP.", null, null),
        new Rank(3, "Unending Wrath", "Rage no longer costs any AP and adds your full Brawn to your damage. In addition, whenever you would gain exhaustion because of Rage, you gain one less application.", null, null),
    ],
    "Berserker");

export const specializationMarauder: RankOption = new RankOption("Marauder", specializationCategory,
    [
        new Rank(1, "Titan Grip", "You can now wield two-handed weapons in one hand. (Does not apply to bows) The AP cost of all two-handed melee weapons is decreased by 2 (minimum of 1)", null, null),
        new Rank(2, "Endless Rage", "Rage can be activated at any time, including out of turn. You no longer need to roll to activate Rage. The duration of Rage now lasts until the end of the encounter. Whenever you would gain exhaustion because of Rage, you gain one less application.", null, null),
        new Rank(3, "Godlike Strength", "Whenever an attack you make would add your brawn to increase the damage, you add your brawn two more times. In addition, you gain +2 titan soak.", null, null),
    ],
    "Marauder");
...
export const specializationPoisoner: RankOption = new RankOption("Poisoner", specializationCategory,
    [
        new Rank(1, "Quick Applications", "It costs you 1 less AP to apply oils and poisons (such as the ability, Envenomed Weapons) to your weapons.", null, null),
        new Rank(2, "Pick Your Poison", "You learn a number of augments, listed below, that you can apply to any [Poison] ability.", null, augmentSetPoisonerPickYourPoison),
        new Rank(3, "Poison Master", "Your [Poison] abilities deal 3 extra damage. When making oil brews, the price to make them is reduced by half and you gain double the normal amount of applications. In addition, whenever you apply oils or poisons to your weapons, it automatically applies to any other weapon you are wielding. This only counts as one application.", null, null),
    ],
    "[Poison]");

export const specializationAdventurer: RankOption = new RankOption("Adventurer", specializationCategory,
    [
        new Rank(1, "Gear Up", "The AP cost to drink potions, poultices and elixirs is reduced by 1. Your carrying capacity is increased by 3. Once per day when you find gold through adventuring, you find an extra 250 that nobody else notices.", null, null),
        new Rank(2, "Basic Training", "Your [Basic] abilities gain +1 potency. You gain +1 to movement speed. You gain +1 to initiative. You gain +1 soak. You gain +1 HP.", null, null),
        new Rank(3, "Experienced", "Anytime you purchase the first rank of anything, it costs 1 less experience. In addition, all abilities you know gain the [Basic] label", null, null),
    ],
    "Adventurer");
...
export const specializationAssassin: RankOption = new RankOption("Assassin", specializationCategory,
    [
        new Rank(1, "Sneak Attack", "If you attack a creature while hidden from them, the attack deals +3 damage.", null, null),
        new Rank(2, "Weak Point", "You gain an augment that can be applied to any single-target ability that deals damage.", null, augmentSetAssassinWeakPoint),
        new Rank(3, "Killer", "Once per round, after dropping a creature to 0 health, you may perform a [Basic] ability for no AP. Weak Point no longer costs an augment slot.", null, null),
    ],
    "[Skulker]");
...
export const specializationShadow: RankOption = new RankOption("Shadow", specializationCategory,
    [
        new Rank(1, "Hidden", "Attacking a creature while hidden from them grants you +2 automatic successes instead of just one.", null, null),
        new Rank(2, "Stalker", "The range of the ability, Ambush, is increased by 30’. In addition, you gain a few augments that can only be applied to the ability, Ambush.", null, augmentSetShadowStalker),
        new Rank(3, "Knife in the Dark", "Making an attack no longer automatically reveals you if you are hidden. The difficulty of all stealth rolls are reduced by 1.", null, null),
    ],
    "[Skulker]");
...
export const specializationMyrmidon: RankOption = new RankOption("Myrmidon", specializationCategory,
    [
        new Rank(1, "Defensive", "The defensive quality on weapons is increased by 1 for you. In addition, shortswords you wield gain the defensive quality.", null, null),
        new Rank(2, "Deflect", "Parry gains +1 augment slot. In addition, you gain a few augments that can only be applied to Parry.", null, augmentSetMyrmidonDeflect),
        new Rank(3, "Master of the Blade", "You can never be disarmed. You deal 3 extra damage with all attacks using weapons with the defensive trait. You gain two augments that can be applied to any ability you use with a weapon that has the defensive trait.", null, augmentSetMyrmidonMasterOfTheBlade),
    ],
    "Myrmidon");
...
export const specializationWhisper: RankOption = new RankOption("Whisper", specializationCategory,
    [
        new Rank(1, "Keep them at bay", "Rapiers you wield gain the defensive trait. The range of weapons with the thrown trait is increased by 30’", null, null),
        new Rank(2, "Skewer", "Attacks against creatures with 0 soak (determined after factoring in abilities and attacks that bypass soak) deal 5 extra damage. You gain two augments that can be applied to any ability you use with a weapon that has the penetrating trait.", null, augmentSetWhisperSkewer),
        new Rank(3, "Puncture", "Attacks you do that have the penetrating quality now pierce titan soak. Creatures cannot benefit from the penetrating trait against you.", null, null),
    ],
    "Whisper");
...
export const specializationReaver: RankOption = new RankOption("Reaver", specializationCategory,
    [
        new Rank(1, "Raid", "Once per day, when going through the pockets of a corpse, you find 250g that only you notice. You can ask for small favors or for non-expensive items from townsfolk. Most standard townsfolk will fear retribution and follow your commands “willingly”.", null, null),
        new Rank(2, "Rend", "You gain a few new augments that can be applied to any [Melee] abilities.", null, augmentSetReaverRend),
        new Rank(3, "Pillage", "You may perform one move action on each of your turns for no AP cost. All  abilities performed through an axe (hand axe, battle axe or greataxe) gain +1 augment slot and +2 potency.", null, null),
    ],
    "Reaver");
...
export const specializationDreadnought: RankOption = new RankOption("Dreadnought", specializationCategory,
    [
        new Rank(1, "Smash", "The difficulty decrease due to a target within 5’ being prone is increased to 2.", null, null),
        new Rank(2, "Powerful Swings", "You gain a few new augments that can be applied to any ability used with a weapon with the concussive trait.", null, augmentSetDreadnoughtPowerfulSwings),
        new Rank(3, "Curb Stomp", "[Weapon] Abilities used against prone creatures gain +1 augment slot and +3 potency. You cannot be knocked prone.", null, null),
    ],
    "Dreadnought");
...
export const specializationDragoon: RankOption = new RankOption("Dragoon", specializationCategory,
    [
        new Rank(1, "Graceful", "Armor you wear is considered to have 2 less weight", null, null),
        new Rank(2, "Keep at Arm’s Reach", "You gain a few new augments that can be applied to any ability performed using weapons with the reach trait.", null, augmentSetDragoonKeepAtArm_sReach),
        new Rank(3, "Pierce the Veil", "Spears or halberds you wield now have the Penetrating quality. All abilities performed using a weapon with the reach trait gains +1 augment slot.", null, null),
    ],
    "Dragoon");
...
export const specializationWeaponMaster: RankOption = new RankOption("Weapon Master", specializationCategory,
    [
        new Rank(1, "Armory", "Up to five weapons you carry have no weight for you. In addition, you can store or bring out weapons for no AP cost. You gain an augment that can be applied to any [Weapon] ability you perform.", null, augmentSetWeaponMasterArmory),
        new Rank(2, "Practice Makes Perfect", "You gain the benefit of Focus for all Brawl, Melee and Ranged rolls if you have at least 4 ranks in those skills. You gain an augment that can be applied to any [Weapon] ability you perform.", null, augmentSetWeaponMasterPracticeMakesPerfect),
        new Rank(3, "Perfect Counter", "While wielding a specific weapon, you are immune to damage from that type of weapon (as in, wielding a rapier makes you immune to rapiers) In addition, all of your [Weapon] abilities gain +1 augment slot. You gain an augment that can be applied to any [Weapon] ability you perform.", null, augmentSetWeaponMasterPerfectCounter),
    ],
    "Weapon Master");

export const specializationTinkerer: RankOption = new RankOption("Tinkerer", specializationCategory,
    [
        new Rank(1, "Gadgeteer", "Once per day, you can grab any rank 1 machine out of your belt. It functions just as if you made it with one success. In addition, weapons you wield with any modifications deal +3 damage.", null, null),
...
export const specializationArchery: RankOption = new RankOption("Archery", specializationCategory,
    [
        new Rank(1, "Take Aim", "Increase the range of all [Weapon] abilities that have a range by 30’. In addition, you gain an augment that can only be used on the ability, Size Up.", null, augmentSetArcheryTakeAim),
        new Rank(2, "Ranger", "You gain two augments that can only be applied to [Ranged] + [Weapon] abilities.", null, augmentSetArcheryRanger),
        new Rank(3, "Muscle Memory ", "You no longer need to spend any AP to load an arrow into a bow. In addition, Size Up gains +1 augment slot.", null, null),
    ],
    "[Ranged]");
...
export const specializationCrossbowExpert: RankOption = new RankOption("Crossbow Expert", specializationCategory,
    [
        new Rank(1, "Good Aim", "You suffer no penalties for using a ranged weapon while an enemy is within 5’ of you. In addition, you gain an augment that can only be used on the ability, Size Up. 2: You gain two augments that can only be applied to [Ranged] + [Weapon] abilities.", null, augmentSetCrossbowExpertGoodAim),
        new Rank(2, "Loading", "Weapons, except for Bows, you wield cost 1 less AP to load. (This can cause loading to cost no AP). The ability, Rapid Fire, can now be used once per encounter instead of once per day.", null, null),
    ],
    "[Ranged]");
...
export const specializationGunslinger: RankOption = new RankOption("Gunslinger", specializationCategory,
    [
        new Rank(1, "Good Maintenance", "The malfunction trait on weapons you wield no longer triggers. In addition, you gain an augment that can only be used on the ability, Size Up.", null, augmentSetGunslingerGoodMaintenance),
        new Rank(2, "Gunslinger", "You gain a few new augments that can only be applied to [Ranged] + [Weapon] abilities.", null, augmentSetGunslingerGunslinger),
        new Rank(3, "Hit Man", "You expertise with gunplay has reached masterful levels. This bonus affects different guns in different ways based on the three traits: single shot, 3 shot clip and 6 shot clip. Single Shot - Requires 2 Less AP to load all of your single shot weapons. They also gain the concussive trait. 3 Shot Clip - When you use the size up action while wielding any 3 shot clip weapon, your next attack gains +1 automatic success. In addition, if you have at least one automatic success on any attack you do with this weapon, you may add your senses to your damage. 6 Shot Clip - Anytime you load a 6 shot clip weapon, you may also load another 6 shot clip weapon in your hand for no AP cost. All of your 6 Shot Clip weapons gain the Penetrating trait.", null, null),
    ],
    "[Ranged]");

export const specializationHunter: RankOption = new RankOption("Hunter", specializationCategory,
    [
        new Rank(1, "Survivalist", "Reduce the difficulty to track by 1. You may ignore the first 5 weight of animal parts (hide, meat, etc)", null, null),
        new Rank(2, "Stand Your Ground", "You can no longer be knocked prone or forcefully moved. Dwarves may buy this rank for half the normal cost.", null, null),
        new Rank(3, "Companionship", "Your companions deal +2 damage with all of their attacks, gain +1 to their health multiplier and gain +1 command limit.", null, null),
    ],
    "Hunter");

export const specializationCavalier: RankOption = new RankOption("Cavalier", specializationCategory,
    [
        new Rank(1, "Born to the Saddle", "The penalties you suffer while riding a mount are reduced by 2 for you. If you normally do not suffer any penalties while mounted, you instead deal +2 damage on all attacks while mounted.", null, null),
        new Rank(2, "Mounted Combat", "You no longer suffer a difficulty increase when using a short weapon to attack while mounted. In addition, when mounted, the difficulty to use all other weapons is decreased by 1. You deal +2 damage with all attacks while mounted.", null, null),
        new Rank(3, "Inspiring Leader", "Whenever you spend a point of resolve, all allies within 60’ gain 10 temporary health and gain +1 AP on their next turn.", null, null),
    ],
    "[Inspire]");
...
export const specializationMartialArtist: RankOption = new RankOption("Martial Artist", specializationCategory,
    [
        new Rank(1, "Lethal Hands", "Unarmed attacks lose the nonlethal property. Weapons with the Full-body trait deal +2 damage. 2: Maneuvers- You gain new augments that can be applied to any [Brawl] + [Weapon] ability.", null, augmentSetMartialArtistLethalHands),
        new Rank(2, "Conditioning", "The difficulty of Dodging is reduced by 1. Unarmed attacks gain the Simple and Concussive trait. All [Brawl] + [Weapon] abilities you perform gain +1 augment slot.", null, null),
    ],
    "Martial Artist");
...
export const specializationBlazingWrath: RankOption = new RankOption("Blazing Wrath", specializationCategory,
    [
        ...
        new Rank(2, "Burn", "You take 3 less damage from all sources when it is your turn. In addition, you learn an augment that can be used on any [Fire] + [Spell] ability you cast.", null, augmentSetBlazingWrathBurn),
        new Rank(3, "Fire Savant", "Whenever you activate the Burn augment, you may choose to have another creature within 5’ also suffer the same effects. This cannot be done to creatures that are already on fire. In addition, you deal an extra 5 damage from all sources when it is not your turn.", null, null),
    ],
    "[Fire, Elemental]");
...
export const specializationMysticTorrent: RankOption = new RankOption("Mystic Torrent", specializationCategory,
    [
        new Rank(1, "Understanding the Current", "You gain a swim speed equal to your movement speed. If you already had a swim speed, gain +2 to your swim speed. In addition, you may use Intellect instead of Senses when casting a [Water] + [Spell] ability.", null, null),
        new Rank(2, "Deluge", "You can now breathe underwater. In addition, you learn two augments that can be used on any [Water] + [Spell] ability you cast.", null, augmentSetMysticTorrentDeluge),
        new Rank(3, "Amphibious", "The number of successes applied by Deluge and Downpour is increased to 2. Additionally, your [Water] abilities have their difficulty reduced by 1 and their potency increased by 3.", null, null),
    ],
    "[Water, Elemental]");
...
export const specializationEruptingEarth: RankOption = new RankOption("Erupting Earth", specializationCategory,
    [
        new Rank(1, "Earth Sight", "You can, at will, see through earth or stone as long as it is no wider than 5ft. This effect can be turned on and off at will.  In addition, you may use Intellect instead of Brawn when casting a [Earth] + [Spell] ability.", null, null),
        new Rank(2, "Topple", "Your [Earth] + [Spell] abilities gain +3 potency. In addition, you learn an augment that can be used on any [Earth] + [Spell] ability you cast.", null, augmentSetEruptingEarthTopple),
        new Rank(3, "Titan of Stone", "You gain +1 titan soak, +1 HP and +1 die to all brawn rolls. You cannot be moved against your will. Finally, all abilities you perform ignore the difficulty increase from the prone condition.", null, null),
    ],
    "[Earth, Elemental]");
...
export const specializationHowlingZephyr: RankOption = new RankOption("Howling Zephyr", specializationCategory,
    [
        new Rank(1, "Unending Air", "You can never run out of breath, even if underwater or in a place where oxygen couldn't be, such as space. You lose this benefit if you are unconscious.  In addition, you may use Intellect instead of Subterfuge when casting a [Air] + [Spell] ability.", null, null),
        new Rank(2, "Advantage", "Your movement speed is increased by 2. In addition, you learn two augments that can be used on any [Air] + [Spell] ability you cast. 3: Lord of the Sky- You can now fly. You gain a fly speed equal to your movement speed. If you had a fly speed before, you gain +2 to it. Additionally, enemies within 30’ of you are considered to have one less brawn for purposes of their breath (Minimum of 1). Finally, your [Air] abilities have +3 potency.", null, augmentSetHowlingZephyrAdvantage),
    ],
    "[Air, Elemental]");
...
export const specializationStaticCharge: RankOption = new RankOption("Static Charge", specializationCategory,
    [
        new Rank(1, "Static Charge", "Whenever a lightning spell is cast within 30’ of you, you gain +1 stacking temporary hit points. These hit points last until the end of the encounter. In addition, you may use Intellect instead of Dexterity when casting a [Lightning] + [Spell] ability.", null, null),
        new Rank(2, "Vulnerability", "Your [Lightning] abilities gain +3 potency. In addition, you learn an augment that can be used on any [Lightning] + [Spell] ability you cast.", null, augmentSetStaticChargeVulnerability),
        new Rank(3, "System Shock", "Whenever you deal lightning damage to a creature, unless they have at least 2 ranks in lightning specializations, they cannot take out-of-turn actions until the start of their next turn. Additionally, if a creature within 120’ is subject to an at least one instance of your Vulnerability secondary effect, you can spend 1 AP to maintain the Vulnerability secondary effect on that target.", null, null),
    ],
    "[Lightning, Elemental]");
...
export const specializationFrozenDeluge: RankOption = new RankOption("Frozen Deluge", specializationCategory,
    [
        new Rank(1, "Icy Step", "Any time your feet would touch water, you may choose to freeze the water where you step. The water thaws in mere moments after you lift your feet back up. This allows you to walk across water unimpeded.", null, null),
        new Rank(2, "Freeze", "Your [Ice] abilities gain +3 potency. In addition, you learn an augment that can be used on any [Ice] + [Spell] ability you cast.", null, augmentSetFrozenDelugeFreeze),
        new Rank(3, "Master of Frost", "Your Icy Step bonus is improved to work on any liquids. This will even work on exceptionally hot liquids, such as lava, but you cannot stop moving while on these liquids. Any time you reduce the movement speed of a target, their movement speed is reduced by 1 more. Your [Ice] abilities gain +3 potency.", null, null),
    ],
    "[Ice, Elemental]");
...
export const specializationCryomancer: RankOption = new RankOption("Cryomancer", specializationCategory,
    [
        new Rank(1, "Snowstorm", "You can choose for all rain within 1 mile of you to turn to snow. You can withstand extremely cold environments.", null, null),
        new Rank(2, "Ice Magician", "You learn a few new augments that can be applied to any [Ice] + [Spell] abilities you cast.", null, augmentSetCryomancerIceMagician),
        new Rank(3, "Cryomancy", "Your [Ice] abilities gain +1 augment slot and the difficulty is reduced by 1. You gain +1 soak.", null, null),
    ],
    "[Ice, Elemental]");
...
export const specializationOozingAcid: RankOption = new RankOption("Oozing Acid", specializationCategory,
    [
        new Rank(1, "Destroy", "You can put your hands on a surface and melt it. You melt through 3’ of material per minute. Certain materials cannot be melted in this way, as determined by the GM.", null, null),
        new Rank(2, "Dissolve", "You learn a few new augments that can be used on any [Acid] abilities you perform.", null, augmentSetOozingAcidDissolve),
        new Rank(3, "Corrosive Soul", "Your passive ability to melt materials changes from 3’ per minute to 3’ per second. All [Acid] abilities you perform gain +2 augment slots.", null, null),
    ],
    "[Acid]");
...
export const specializationWizard: RankOption = new RankOption("Wizard", specializationCategory,
    [
        new Rank(1, "Knowledgeable", "If you have at least 4 ranks in the Knowledge skill, all rolls using this skill gain the benefit as if your focus applied.", null, null),
        new Rank(2, "Malleable Spells", "You learn a number of augments you can apply to [Force] + [Spell] abilities.", null, augmentSetWizardMalleableSpells),
        new Rank(3, "Spellweaving", "All of your augments gained through Malleable Spells can be applied to any [Spell] ability. In addition, your [Force] + [Spell] abilities gain +1 augment slot.", null, null),
    ],
    "[Force]");

export const specializationArchmage: RankOption = new RankOption("Archmage", specializationCategory,
    [
        new Rank(1, "Students", "As an archmage, students flock to learn from you. You gain three retainers per the Retainers background. These retainers are all apprentice mages. They have 1 rank in Ritual Casting and 1 rank in any arcane specialization of your choice. They will never help you in combat. They can be instructed to do menial tasks or chores, but are likely to be bad at them. If treated badly, these apprentices can choose to leave. You may replace one of the apprentices with a new one as you see fit, but doing this too much may burn bridges and prevent you from getting new apprentices in the future.", null, null),
        new Rank(2, "Studious", "The cost to purchase [Spell] abilities is reduced by half for you.", null, null),
        new Rank(3, "Spellcrafter", "You may use any [Spell] based augments on any [Spell] ability, regardless of the other requirements. In addition, all of your [Spell] abilities gain +1 augment slot.", null, null),
    ],
    "[Force]");
...
export const specializationIllusionist: RankOption = new RankOption("Illusionist", specializationCategory,
    [
        new Rank(1, "Improved Illusions", "The Illusion ability gains +1 augment slot per rank of any [Illusion] specialization you have. In addition, you gain new augments that can only be applied to the ability, Illusion.", null, augmentSetIllusionistImprovedIllusions),
        new Rank(2, "Prolonged Illusions", "All [Illusion] abilities you cast have their duration doubled. The difficulty to disbelieve any of your [Illusion] abilities is increased by 1. The Disguise ability can also change the sound of the target’s voice.", null, null),
        new Rank(3, "Master Illusionist", "Your illusions from the ability, Illusion, now can become real. At any point after creating an illusion, before it goes away, you can spend 1 resolve to give it permanence. You no longer need to maintain the illusion to keep it around. In addition, the AP cost of Illusion is reduced by 3 (minimum of 1) and the first one you choose to maintain costs no AP to maintain.", null, null),
    ],
    "[Illusion]");
...
export const specializationTrickster: RankOption = new RankOption("Trickster", specializationCategory,
    [
        new Rank(1, "Reach", "You have learned how to manipulate things from far away, interacting with it as if you were adjacent. You may interact with objects up to 30’ away. This could include picking a pocket, unlocking a door, or grabbing a light object. You cannot carry or move objects heavier than 5 pounds.", null, null),
        new Rank(2, "Unseen", "You gain a few augments that can be applied to Invisibility and Supreme Invisibility.", null, augmentSetTricksterUnseen),
        new Rank(3, "Magical Ambush", "If you are hidden from a creature and attempt to cast a [Spell] ability against them, the difficulty is reduced by 2. In addition, Invisibility and Supreme Invisibility gain +1 augment slot. Supreme Invisibility costs 1 less AP to maintain.", null, null),
    ],
    "[Illusion]");

export const specializationSpellblade: RankOption = new RankOption("Spellblade", specializationCategory,
    [
        new Rank(1, "Weapon Sight", "You know the presence of all weapons within 30’. You also know the type and function (such as ‘Type; longsword, Function; cutting). This only applies to objects that were designed to function as weapons.", null, null),
        new Rank(2, "Augmented Attacks", "Your [Weapon] tagged abilities can now deal force damage instead of their regular damage type. If you have at least 2 total ranks of any combination of specializations that are tagged with a damage type, you may do that damage type instead. When dealing that damage, the ability used also gains that damage’s tag.", null, null),
        new Rank(3, "Spellweaver", "You gain 1 extra AP each turn that can only be spent on maintaining abilities. In addition, any augment you know that are for abilities with the [Spell] tag can be used on any [Weapon] tagged ability, regardless of the other tags.", null, null),
    ],
    "Spellblade");

export const specializationBloodMagician: RankOption = new RankOption("Blood Magician", specializationCategory,
    [
        new Rank(1, "Blood Magic", "You unlock the secrets to blood magic. Anytime you cast a [Spell] tagged ability, you may spend hit points equal to the AP cost (before modifications) to cast it for no AP. You may only activate Blood Magic once on your turn.", null, null),
        new Rank(2, "Hastened Blood", "You may cast a [Spell] ability using Blood Magic out-of-turn once per round. All abilities used in this way gain the [Out-of-Turn] tag. In addition, all of your blood magic costs 1 less health.", null, null),
        new Rank(3, "Potent Blood", "Once per encounter when dealing damage with a [Spell] ability, you may choose to heal for an amount equal to the damage dealt. In addition, you may use Blood Magic using any of your companion’s health instead of your own.", null, null),
    ],
    "Blood Magician");

export const specializationLifedrinker: RankOption = new RankOption("Lifedrinker", specializationCategory,
    [
        new Rank(1, "Bloodletting", "You can choose when using a [Weapon] tagged ability to have a creature within 30’ to be inflicted with the same amount of damage as the original target (determined before soak). You may use Blood Magic for [Weapon] tagged abilities. Every time you do, any creatures of your choice within 30’ are affected by the augments you use. In addition, you gain access to the Bloodfiend ability.", null, null),
        new Rank(2, "Lifestealer", "Any effect you do that heals you based off of damage that you deal gives you double the normal amount of health. In addition, the first sentence of Potent Blood no longer has a limited amount of uses, other than your available heals per full rest, and can be used with [Weapon] tagged abilities as well.", null, null),
...
export const specializationSage: RankOption = new RankOption("Sage", specializationCategory,
    [
        new Rank(1, "Renaissance Man", "You get +1 die to all rolls.", null, null),
        new Rank(2, "Stable Mind", "You are immune to the confusion condition. You gain +1 maximum resolve.", null, null),
        new Rank(3, "Anything can be learned", "An attunement sphere of your choice drops by 2. (For example, if your divine attunement is 8x, it would now be 6x) This can be applied to the Universal attunement sphere. You cannot choose a sphere if it would go below 3x.", null, null),
    ],
    "Sage");

export const specializationAlchemist: RankOption = new RankOption("Alchemist", specializationCategory,
    [
        new Rank(1, "Adept Alchemist", "The difficulty of creating brews is reduced by 1", null, null),
        new Rank(2, "Better Brews", "All salves you create have their duration doubled. In addition, whenever you through a splash potion, you can choose what creatures in the area of effect it affects or not.", null, null),
        new Rank(3, "Bountiful Brews", "You may have two elixirs active at once. In addition, you can use each kind of poultice twice per day.", null, null),
        new Rank(4, "Philosopher’s Stone", "You have discovered the secret to the Philosopher’s Stone. Once per day, you may at any time gain the effects of any brew you have made. This can be done on any turn, including as a response to taking damage, but before applying your soak. (change to :can transform any material into another material)", null, null),
    ],
    "[Brewing]");

export const specializationSpellMastery: RankOption = new RankOption("Spell Mastery", specializationCategory,
    [
        new Rank(1, "Spell Sight", "When anybody that you can see casts a [Spell] ability within 120’ of you, you automatically know the specifics of the spell, including what sphere it is from, and the description of the spell.", null, null),
        new Rank(2, "Spell Sculptor", "Any time you cast a [Spell] ability that affects targets in an area of effect, you may select targets inside that area of effect to ignore the effects of your spell.", null, null),
        new Rank(3, "Spell Master", "You can maintain one [Spell] ability at a time for no AP cost. Additionally, you may cast 3 [Spell] abilities per day for no AP cost. You can only use this effect once per turn.", null, null),
    ],
    "Spell Mastery");
...
export const specializationCrusader: RankOption = new RankOption("Crusader", specializationCategory,
    [
        new Rank(1, "Sense Evil", "You innately know if creatures are evil. You must know of their presence before this knowledge comes to you. This is considered a mind reading effect. You deal +2 damage on all attacks when within 60’ of an evil creature.", null, null),
        new Rank(2, "Blinding Strike", "Your [Weapon] abilities can no longer be parried. In addition, you gain a new augment you can apply to any [Weapon] ability.", null, augmentSetCrusaderBlindingStrike),
        new Rank(3, "True Crusader", "After you reduce a creature to 0 health, you may perform a [Basic] ability for no AP cost. This can only happen once per round. In addition, all of your soak is converted to Titan Soak.", null, null),
    ],
    "Crusader");
...
export const specializationExemplar: RankOption = new RankOption("Exemplar", specializationCategory,
    [
        new Rank(1, "Holy Light", "All healing you receive is increased by 3.", null, null),
        new Rank(2, "Restore the Faithful", "All of your abilities deal +3 damage. In addition, you gain an augment that can be applied to any ability.", null, augmentSetExemplarRestoreTheFaithful),
        new Rank(3, "Radiant Champion", "When you use Cauterize, if there are multiple creatures being affected, you can choose which creatures are healed and which take damage as normal. In addition, anytime a creature regains health because of you, you may have them also gain 10 temporary health, which lasts until the end of the encounter.", null, null),
    ],
    "[Heal]");

export const specializationRevenant: RankOption = new RankOption("Revenant", specializationCategory,
    [
        new Rank(1, " Incorporeal", "You can now go partially incorporeal at will, like a ghost. While you are incorporeal, you may move through the space occupied by a creature, as long as you don’t end your turn occupying the same space as another creature. You gain +1 soak against all attacks that target you.", null, null),
        new Rank(2, "Corrupted Touch", "Any time you deal damage to a creature, their maximum health is reduced by the amount of damage they take. This doesn’t work on creatures who aren’t truly alive, such as undead or constructs. In addition, once per encounter you may heal for the same amount of damage you deal on any attack. (Determined after soak.) You can decide after making the attack roll.", null, null),
        new Rank(3, "Spectre", "While you are incorporeal, you may travel through solid surfaces at the cost of 2 speed per square of movement, but may never end your turn inside a solid surface. You gain +1 soak against all attacks that target you. You gain a fly speed equal to your movement speed. If you had a fly speed before, it is instead increased by 2.", null, null),
    ],
    "Revenant");

export const specializationMissionary: RankOption = new RankOption("Missionary", specializationCategory,
    [
        new Rank(1, "Missionary Training", "All healing you do is increased by 3. You add +1 die to all knowledge, leadership, medicine and survival rolls", null, null),
        new Rank(2, "Spread the Faith", "Your movement speed is increased by 3. The difficulty of all persuasion and intimidate checks is reduced by 1 for you.", null, null),
        new Rank(3, "Faithful", "You are immune to being enthralled and confused. You gain +1 maximum resolve.", null, null),
    ],
    "Missionary");
...
export const specializationPurifier: RankOption = new RankOption("Purifier", specializationCategory,
    [
        new Rank(1, "Firewalker", "You may walk through most standard fires without being hurt. This does not give you immunity or resistance to fire damage.", null, null),
        new Rank(2, "Purifying Flames", "You learn a few new augments that can be applied to all [Fire] + [Spell] abilities you cast.", null, augmentSetPurifierPurifyingFlames),
        new Rank(3, "Divine Cleansing", "Your [Fire] abilities gain +1 augment slot and +3 potency. You gain +1 HP.", null, null),
    ],
    "[Fire, Elemental]");
...
export const specializationStormcaller: RankOption = new RankOption("Stormcaller", specializationCategory,
    [
        new Rank(1, "Lightning Caller", "Anytime a [Lightning] ability is used within 120’ of you, you can choose to absorb the effects entirely. This only works on single target effects. In addition, you may use Presence instead of Dexterity for any [Lightning] + [Spell] ability.", null, null),
        new Rank(2, "Insulated", "You gain +5 titan soak vs lightning damage. In addition, you gain an augment that can only be applied to [Lightning] + [Spell] abilities.", null, augmentSetStormcallerInsulated),
        new Rank(3, "Stormborn", "Anytime a [Lightning] ability affects you, you gain +2 AP on your next turn and +3 potency on your next [Lighting] ability. In addition, anytime you would receive lightning damage, you can instead heal for the same amount. This causes you to not gain the AP and potency bonus.", null, null),
    ],
    "[Lightning, Elemental]");
...
export const specializationInquisitor: RankOption = new RankOption("Inquisitor", specializationCategory,
    [
        new Rank(1, "Finding what is Hidden", "You now ignore the obscured condition on enemies. In addition, you may use Presence instead of Subterfuge when casting a [Shadow] + [Spell] ability.", null, null),
        new Rank(2, "Seeking in the Dark", "You are aware of the location of any creature 30’. If you could not otherwise see the creature, you are considered blind in relation to it. In addition, you gain an augment that can be applied to any [Shadow] + [Spell] ability you cast.", null, augmentSetInquisitorSeekingInTheDark),
        new Rank(3, "Interrogator", "After you inflict the restrained condition on a creature, you can choose to end the restrained condition on the creature. If you do so, the creature then becomes paralyzed until it has been hit a number of times equal to the number of turns the restrained condition would have lasted. Additionally, abilities targeting creatures within 30’ of you do not suffer penalties due to blindness.", null, null),
    ],
    "[Shadow]");
...
export const specializationInvoker: RankOption = new RankOption("Invoker", specializationCategory,
    [
        new Rank(1, "Versatile", "You may purchase any [Buff] tagged ability, regardless of any prerequisites. 2: You gain a few augments that can be applied to any [Buff] ability.", null, augmentSetInvokerVersatile),
        new Rank(2, "Concentration", "You gain +3 AP each round that can only be spent on maintaining [Buff] abilities. In addition, creatures cannot dispel or otherwise remove any [Buff] abilities you perform.", null, null),
    ],
    "Invoker");
...
export const specializationAcolyte: RankOption = new RankOption("Acolyte", specializationCategory,
    [
        new Rank(1, "Divine Plea", "Once per full rest you may call upon the deities for divine help. Any time you attempt a task, you may declare your earnest plea before the party, and if the GM decides it is heartfelt, you automatically succeed the roll. The result will generally be miraculous in nature, if at all possible.", null, null),
        new Rank(2, "Resolve of the Faithful", "You may now spend your resolve to remove 1 stack of exhaustion. Any time you spend resolve to reroll a roll, that roll gains +1 automatic success. You may spend your resolve to force a single target attack targeting you only to miss.", null, null),
        new Rank(3, "Favored", "Your attributes and skills can be raised to 6. At the end of each session, you gain +1 experience.", null, null),
    ],
    "Acolyte");
...
export const specializationOracle: RankOption = new RankOption("Oracle", specializationCategory,
    [
        new Rank(1, "Aware", "When you spend AP to improve your initiative at the start of combat, every AP you spend increases your initiative by 3. You always decide last when to spend AP to adjust your initiative. You gain +2 to your initiative.", null, null),
        new Rank(2, "Predication", "You deal 3 extra damage with all of your attacks against creatures who have lower initiative then you. In addition, the AP cost of Parry and Dodge is reduced by 1 against their attacks. You gain +1 AP each round that can only be used for [Out-of-Turn] abilities.", null, null),
        new Rank(3, "Oracle of the Ages", "Add +3 to your initiative checks. If you have the highest initiative in a fight, then all enemies are stunned and doomed on the first round of combat.", null, null),
    ],
    "Oracle");

export const specializationProphet: RankOption = new RankOption("Prophet", specializationCategory,
    [
        new Rank(1, "Tarot Reader", "Once per day you may foresee someone’s future with a tarot card without expending the tarot card. In addition, you can change one effect on any tarot cards you make without increasing the difficulty", null, null),
        new Rank(2, "Prophecy Savant", "The difficulty of all prophecy crafting is reduced by 2 for you", null, null),
        new Rank(3, "Charm Reserves", " Prophecy Master - All prophecy crafting you do requires half the gold and time. In addition, the difficulty of all prophecy crafting you do is reduced by 1. In addition, charms you wear can trigger twice per encounter.", null, null),
    ],
    "[Prophecy]");
...
export const specializationFate: RankOption = new RankOption("Fate", specializationCategory,
    [
        ...
        new Rank(2, "Not My Fate", "If an attack would bring you down to 0 health exactly, you may spend a twist and instead of taking damage, you heal for the same amount. This doesn't count towards the number of times you can be healed each day. In addition, you gain 2 more available twists.", null, null),
        new Rank(3, "Fate Favors You", "Whenever you spend a twist and reroll, if the new roll has more 10s than 1s rolled, you regain the twist you just spent. In addition, you gain 2 more available twists. Your twists can now affect creatures out to 120’.", null, null),
    ],
    "Fate");
...
export const specializationDeath: RankOption = new RankOption("Death", specializationCategory,
    [
        new Rank(1, "Sense Death", "You know the location of all undead within 60’ of you. While within the presence of any undead within 60’, your abilities gain +2 potency.", null, null),
        new Rank(2, "Destroyer", "You gain a few new augments that can be applied to any [Necrotic] + [Spell] abilities you know.", null, augmentSetDeathDestroyer),
        new Rank(3, "Death is Inevitable ", "Your [Necrotic] abilities gain +3 potency and +1 augment slot. You are immune to fear and gain +1 HP.", null, null),
    ],
    "[Necrotic]");
...
export const specializationDemonHunter: RankOption = new RankOption("Demon Hunter", specializationCategory,
    [
        new Rank(1, "Demon Sight", "You can sense the presence and type of all fiendish creatures within 60’. You deal +2 damage to all fiendish creatures.", null, null),
        new Rank(2, "Fel Training", "You gain +1 health multiplier. In addition, you learn a new augment that can be applied to any [Weapon] ability.", null, augmentSetDemonHunterFelTraining),
        new Rank(3, "Fight Felfire with Felfire", "Demon Form gains +1 augment slot. In addition, you gain a few augments that can be applied to the ability, Demon Form.", null, augmentSetDemonHunterFightFelfireWithFelfire),
    ],
    "[Demonology]");
...
export const specializationProtection: RankOption = new RankOption("Protection", specializationCategory,
    [
        new Rank(1, "Aura of Protection", "You gain a few augments that can only be used on the Aura ability.", null, augmentSetProtectionAuraOfProtection),
        new Rank(2, "My Body is my Temple", "All healing you recieve is increased by 5. You can be healed 2 more times per full rest than usual. Your health multiplier is increased by 1.", null, null),
        new Rank(3, "Defend the Weak", "Your Aura ability gains +1 augment slot. In addition, you gain some augments for the Taunt ability.", null, augmentSetProtectionDefendTheWeak),
    ],
    "[Tank]");
...
export const specializationRetribution: RankOption = new RankOption("Retribution", specializationCategory,
    [
        new Rank(1, "Aura of Retribution", "You gain a few augments that can only be used on the Aura ability.", null, augmentSetRetributionAuraOfRetribution),
        new Rank(2, "Hunt the Wicked", "The difficulty of all insight and investigation rolls is reduced by 1 for you. In addition, you deal an extra 3 damage with all [Weapon] abilities.", null, null),
        new Rank(3, "Vengeance of the Gods", "Your Aura ability gains +1 augment slot. In addition, you gain a new augment that can be used on any [Weapon] ability.", null, augmentSetRetributionVengeanceOfTheGods),
    ],
    "Retribution");
...
export const specializationChampion: RankOption = new RankOption("Champion", specializationCategory,
    [
        new Rank(1, "Aura of the Champion", "Your Aura ability gains a few new augments.", null, augmentSetChampionAuraOfTheChampion),
        new Rank(2, "Aura Master", "Your Aura ability gains +2 augment slots. In addition, once per encounter you may change the augments currently affecting Aura at-will. All creatures that are affected by your Aura while determining initiative gain +2 to their initiative.", null, null),
        new Rank(3, "True Champion", "Any time you deal damage, you can choose to deal radiant damage instead of the normal damage type. In addition, anytime you deal radiant damage, you deal 5 extra damage. All of your attacks that deal radiant damage ignore all soak, including titan soak.", null, null),
    ],
    "Champion");
...
export const specializationOrderOfTheTemplar: RankOption = new RankOption("Order of the Templar", specializationCategory,
    [
        new Rank(1, "Spell Block", "You may now use Parry against any single target [Spell] ability.", null, null),
        new Rank(2, "Break Concentration", "Anytime you deal damage to a creature, all [Buff] abilities are removed and if the target is maintaining any abilities, they immediately end.", null, null),
        new Rank(3, "Spell Reflect", "Anytime you successfully Parry a [Spell] ability and cause the ability to fail, you may choose to have the ability be reflected back to the caster. The caster suffers the effects of the ability with the number of successes they got before you used Parry. In addition, you gain an augment that can be applied to any ability.", null, augmentSetOrderOfTheTemplarSpellReflect),
    ],
...
export const specializationCompassion_sTouch: RankOption = new RankOption("Compassion's Touch", specializationCategory,
    [
        new Rank(1, "Status", "You know the total health of all friendly creatures within 30’. You also know if they are affected by any adverse effects (such as charmed, poisoned, etc.) If you gain Status again, the range increases to 60’ and affects all creatures.", null, null),
        new Rank(2, "Adept Healer", "You gain a few new augments that can only be applied to [Heal]  abilities.", null, augmentSetCompassion_sTouchAdeptHealer),
        new Rank(3, "Doctor", "The difficulty of all [Heal] abilities you do is reduced by 1. Any time you restore health, you restore 5 more. In addition, any time you remove an adverse condition, the target becomes immune to that adverse effect for 3 rounds.", null, null),
    ],
    "[Heal]");
...
export const specializationAscension: RankOption = new RankOption("Ascension", specializationCategory,
    [
        new Rank(1, "Angelic Wings", "You manifest majestic wings that give you a fly speed of 12. If you already had a fly speed, you may add 4 to that speed instead of being at 12. The difficulty of all intimidate rolls are reduced by 1 for you against evil creatures. The difficulty of all persuasion and leadership rolls are reduced by 1 for you against all other creatures.", null, null),
        new Rank(2, "Divine Gift", "All healing you do is increased by 5 and all radiant damage you do is increased by 5. In addition, you gain an augment that can only be applied to [Radiant] + [Spell] abilities.", null, augmentSetAscensionDivineGift),
        new Rank(3, "Drawing out the Light", "Whenever you heal a creature, that creature on their next turn gains +2 AP and gains +5 potency on all of their abilities. Whenever you deal radiant damage to a creature, that creature on their next turn starts with 2 less AP and deals 5 less damage with all attacks.", null, null),
    ],
    "[Radiant, Heal]");
...
export const specializationAngelicCall: RankOption = new RankOption("Angelic Call", specializationCategory,
    [
        new Rank(1, "Divine Sense", "You know the presence and type of any divine creature within 30’ of you at all times.", null, null),
        new Rank(2, "Call of Light", "You gain a few augments that can only be applied to [Radiant] + [Spell] abilities.", null, augmentSetAngelicCallCallOfLight),
        new Rank(3, "Searing Light", "Any time you deal radiant damage with a spell to a creature, that creature’s soak is reduced by 1. The soak comes back after a long rest. Your [Radiant] abilities gain +3 potency and +1 augment slot.", null, null),
    ],
    "[Radiant]");
...
export const specializationLuna_sServant: RankOption = new RankOption("Luna’s Servant", specializationCategory,
    [
        new Rank(1, "Nocturnal", "You gain the ability to see perfectly in darkness. This bypasses all forms of darkness, even magical darkness. In addition, you may use Senses instead of Subterfuge when casting a [Shadow] + [Spell] ability.", null, null),
        new Rank(2, "Cloaked in Darkness", "When you are obscured, you gain +1 soak. In addition, you gain an augment that can be applied to any [Shadow] + [Spell] ability you cast.", null, augmentSetLuna_sServantCloakedInDarkness),
        new Rank(3, "Enveloping Cloud", "When you are obscured, all of your abilities gain potency equal to your ranks in Subterfuge. In addition, your [Cloud] spells cost 2 less AP to maintain.", null, null),
    ],
    "[Shadow]");
...
export const specializationSol_sServant: RankOption = new RankOption("Sol’s Servant", specializationCategory,
    [
        new Rank(1, "Display the Sun’s Radiance", "You gain the ability to emanate bright light outward. This light shines twice as far and bright as a torch and can be turned on or off at will.  In addition, you may use Senses instead of Presence when casting a [Radiant] + [Spell] ability.", null, null),
        new Rank(2, "Flash", "You are immune to the blind condition from abilities or effects that temporarily blind you. In addition, you learn an augment that can be used on any [Radiant] + [Spell] ability you cast.", null, augmentSetSol_sServantFlash),
        new Rank(3, "Brilliance", "Any creature blinded by a spell you cast also suffers -2 successes on all actions while blinded. Any creature within 5’ of you that damages you take 5 unsoakable radiant damage and is blinded until the start of their next turn.", null, null),
    ],
    "[Radiant]");

export const specializationElementalist: RankOption = new RankOption("Elementalist", specializationCategory,
    [
        new Rank(1, "Force of Nature", "For every 4 ranks you have in [Elemental] specializations, you gain +1 potency for all of your [Elemental] abilities. In addition, you may use any [Fire], [Water], [Ice], [Lightning], [Earth], [Air] specific augments on any [Elemental] ability, regardless of the other tags. (For example using a [Fire] augment with a [Lightning] ability.)", null, null),
        new Rank(2, "Elemental Resistance", "Your training in the elements grants you some protection against them.  For every 4 ranks you have in [Elemental] specializations, you gain +1 stacking Titan Soak against all elements.", null, null),
        new Rank(3, "Elemental Attunement", "For every [Elemental] specialization you have 3 ranks in, you gain a bonus that is different depending on the element. [Fire] - +1 HP [Ice] - +1 resolve [Water] - +3 to all healing you do and receive [Earth] - +1 soak [Air] - +2 movement speed [Lightning] - +2 Initiative [Elemental] - Choose one of the above bonuses to gain", null, null),
    ],
    "[Elemental]");

export const specializationElementalMastery: RankOption = new RankOption("Elemental Mastery", specializationCategory,
    [
        new Rank(1, "Piercing Elements", "Your abilities with the [Elemental] tag ignore Soak, including Titan Soak. In addition, you also bypass any immunity a creature may have to [Elemental] abilities.", null, null),
        new Rank(2, "Infused with the Elements", "The AP cost of all [Elemental] abilities you use is reduced. The reduction is based off the base AP cost. Abilities with a base AP of 2-4 are reduced by 1 AP (minimum of 1). Abilities with a base AP of 5-7 are reduced by 2 AP (minimum of 1)", null, null),
        new Rank(3, "Advanced Adaptation", "Your spells with the [Elemental] tag gain +2 augment slots.", null, null),
    ],
    "[Elemental]");
...
export const specializationDiscipleOfRadi_v: RankOption = new RankOption("Disciple of Radi’v", specializationCategory,
    [
        new Rank(1, "Fire in your Belly", "You can now withstand extremely hot environments. In addition, you may use Senses instead of Presence when casting a [Fire] + [Spell] ability.", null, null),
        new Rank(2, "Impact", "Creatures within 5’ that target you with an attack become staggered until the end of their next turn. This applies after the attack. In addition, you learn an augment that can be used on any [Fire] + [Spell] ability you cast.", null, augmentSetDiscipleOfRadi_vImpact),
        new Rank(3, "One With Flame", "Reduce the difficulty of all [Fire] + [Spell] abilities by 1. Additionally, any time you deal fire damage, that damage is increased by 3. Creatures staggered by effects you produce must spend 1 more resolve to remove any effect other than stagger.", null, null),
    ],
    "[Fire, Elemental]");
...
export const specializationDiscipleOfSpyg: RankOption = new RankOption("Disciple of Spyg", specializationCategory,
    [
        new Rank(1, "Understanding the Current", "You gain a swim speed equal to your movement speed. If you already had a swim speed, gain +2 to your swim speed.", null, null),
        new Rank(2, "Water Cloak", "You can now breathe underwater. In addition, you learn two augments that can only be used on [Water] + [Spell] abilities that you cast.", null, augmentSetDiscipleOfSpygWaterCloak),
        new Rank(3, "One with Water", "While submerged in water, you gain +1 soak, +5 potency on all abilities and all abilities are made at -1 difficulty.", null, null),
    ],
    "[Water, Elemental]");
...
export const specializationHydrologist: RankOption = new RankOption("Hydrologist", specializationCategory,
    [
        new Rank(1, "Different States", "You have a deep understanding of water and its natural forms. Although most of your studies are based on water in its liquid state, you have also learned the basics of water in vapor and solid form. You may apply [Fire] or [Ice] based augments to any [Water] abilities you know.", null, null),
        new Rank(2, "Lifeblood", "Water is known as the lifeblood of the world. Without it, no life could live. Your study of water’s many properties unlocks many secrets. You gain a few augments that can be applied to any [Water] + [Spell] ability.", null, augmentSetHydrologistLifeblood),
        new Rank(3, "Flexibility of Water", "Your [Water] abilities gain +1 augment slot. Your [Water] abilities gain the [Fire] and [Ice] tags. Every ability you perform that deals water damage also deals fire and cold damage . (The damage type is automatically decided between the three to whichever is best against the target)", null, null),
    ],
    "[Water, Elemental]");
...
export const specializationDiscipleOfAleuel: RankOption = new RankOption("Disciple of Aleuel", specializationCategory,
    [
        new Rank(1, "Light as a Feather", "You no longer take fall damage and gain +2 successes on any jump related check. In addition, you may use Senses instead of Subterfuge when casting a [Air] + [Spell] ability.", null, null),
        new Rank(2, "Shifting Winds", "You gain +1 success on all Dodge or Parry rolls. In addition, you learn two augments that can be used on any [Air] + [Spell] ability.", null, augmentSetDiscipleOfAleuelShiftingWinds),
        new Rank(3, "Air Dancer", "You can now fly. Your fly speed is the same as your movement speed. If you could fly before, you gain +2 to your fly speed. All forced movement you do is by increased by 10’, and if they impact another creature or a solid object, they take 5 unsoakable bludgeoning damage. Additionally, if you cause a target to be knocked prone, it costs them 2 extra AP to stand up.", null, null),
    ],
    "[Air, Elemental]");
...
export const specializationDiscipleOfFanhae: RankOption = new RankOption("Disciple of Fanhae", specializationCategory,
    [
        new Rank(1, "Lightning Reflexes", "You may perform an additional [Out-of-Turn] action each round. In addition, you may use Senses instead of Dexterity when casting a [Lightning] + [Spell] ability.", null, null),
        new Rank(2, "Overcharge", "The difficulty to dodge is reduced by 1. In addition, you learn an augment that can be used on any [Lightning] + [Spell] ability you cast.", null, augmentSetDiscipleOfFanhaeOvercharge),
        new Rank(3, "Lightning Soul", "When a creature gains AP from Overcharge, you also gain +1 AP that can only be used for [Out-of-Turn] abilities. (They must survive the attack to gain the bonus). All of your [Lightning] abilities gain +1 augment slot. Finally, all of your [Lightning] abilities have +3 potency.", null, null),
    ],
    "[Lightning, Elemental]");
...
export const specializationDiscipleOfTilik: RankOption = new RankOption("Disciple of Tilik", specializationCategory,
    [
        new Rank(1, "Frozen Soul", "You can now withstand extremely cold environments. In addition, you may use Senses instead of Intellect when casting a [Ice] + [Spell] ability.", null, null),
        new Rank(2, "Snowbound", "You ignore all movement penalties from ice or snow. In addition, you learn an augment that can be used on any [Ice] + [Spell] ability you cast.", null, augmentSetDiscipleOfTilikSnowbound),
        new Rank(3, "Frozen Through", "All of your [Ice] abilities that deal damage gain penetrating. In addition, if you start your turn while on ice or snow, your movement speed is increased by 2 for that turn and your first move action costs 0 AP.", null, null),
    ],
    "[Ice, Elemental]");
...
export const specializationDiscipleOfDawie: RankOption = new RankOption("Disciple of Dawie", specializationCategory,
    [
        new Rank(1, "From the Soil", "You can now walk through stone, dirt, metal, and other materials of the earth. Once you enter the material, you cannot change directions, moving only forward or backwards, until you exit the material. 1 square of movement takes 2 movement while in the earth.  In addition, you may use Senses instead of Brawn when casting a [Earth] + [Spell] ability.", null, null),
        new Rank(2, "Weathered", "You gain +1 soak. In addition, you learn an augment that can be used on any [Earth] + [Spell] ability you cast.", null, augmentSetDiscipleOfDawieWeathered),
        new Rank(3, "Stone Forged", "You are now immune to the stunned effect, regardless of source. Moving through the earth now can be done with no movement penalty. You gain +1 health multiplier.", null, null),
    ],
    "[Earth, Elemental]");
...
export const specializationNaturalist: RankOption = new RankOption("Naturalist", specializationCategory,
    [
        ...
        new Rank(2, "Grasp", "You can speak with all plantlife. In addition, the difficulty of all social rolls with plantlife are reduced by 1. Finally, you gain an augment that can be applied to all [Earth] + [Spell] abilities you cast.", null, augmentSetNaturalistGrasp),
        new Rank(3, "Thorn’s Embrace", "Creatures restrained from an effect you or one of your companions produce are also considered to be staggered. You and all of your companions deal 3 damage against targets that are restrained. You are immune to being restrained.", null, null),
    ],
    "[Earth, Elemental]");

export const specializationNature_sChosen: RankOption = new RankOption("Nature’s Chosen", specializationCategory,
    [
        new Rank(1, "Timeless Body", "You no longer age, and are immune to any effects that magically age you. In addition, you are immune to poisons, diseases and curses. You also gain access to the Plant Beast ability.", null, null),
        new Rank(2, "Commander", "The command limit for each of your companions is increased by 3. In addition, you may give out up to 3 AP to your companions on each of your turns without any AP cost to you. All of your companions gain +2 soak and +5 potency on all of their abilities.", null, null),
        new Rank(3, "Nature’s Protector", "While standing in an area of nature (plants, dirt, sand, etc), you gain +3 titan soak, +1 maximum AP, +3 potency on all abilities, your [Earth] abilities cost 1 less AP (minimum of 1) and you may spend 1 resolve each round without actually losing any resolve.", null, null),
    ],
    "Nature’s Chosen");
...
export const specializationShapeshifter: RankOption = new RankOption("Shapeshifter", specializationCategory,
    [
        new Rank(1, "Animal Form", "Your Shapeshift ability gains +1 augment slot. In addition, you may use the augments listed below whenever casting Shapeshift.", null, augmentSetShapeshifterAnimalForm),
        new Rank(2, "Tough Hide", "Your Shapeshift ability gains +1 augment slot. In addition, you gain +1 health modifier. You may use the augments listed below whenever casting Shapeshift.", null, augmentSetShapeshifterToughHide),
        new Rank(3, "Perfect Form", "Your Shapeshift ability gains +1 augment slot. You no longer need to assume the form of an animal. When you shapeshift, you can choose to gain the benefits of the traits you select without turning fully into an animal. If you do so, you no longer lose your manual dexterity or the ability to speak. You can also hide specific traits. It costs 1 AP to hide traits, in which they retract back into your body. You lose the benefits of the trait until you spend 1 AP to bring it back out. The AP cost to extend and retract your claws/fangs is reduced by 1.You may use the augments listed below whenever casting Shapeshift.", null, augmentSetShapeshifterPerfectForm),
    ],
    "[Tank]");
...
export const specializationDefiler: RankOption = new RankOption("Defiler", specializationCategory,
    [
        new Rank(1, "Corrupted Body", "Your maximum health can never be reduced. In addition, you may use Senses instead of Subterfuge when casting a [Necrotic] + [Spell] ability.", null, null),
        new Rank(2, "Wither", "You may choose to wither any plant you touch. In addition, you learn an augment that can be used on any [Necrotic] + [Spell] ability you cast.", null, augmentSetDefilerWither),
        new Rank(3, "Corruptor's Touch", "Any time you deal necrotic damage, the target’s maximum health is reduced by the same amount. (When healed, the creature can only be healed up to the new maximum.) A creature’s maximum health is restored to normal after a long rest or if cured by an effect that can remove curses. Additionally, when you kill a target with necrotic damage, you gain hit points equal to your total ranks in any [Necrotic] specializations. This does not count as a heal.", null, null),
    ],
    "[Necrotic]");
...
export const specializationMephite: RankOption = new RankOption("Mephite", specializationCategory,
    [
        new Rank(1, "Poison Sight", "You automatically know, out to 30ft, when a creature is venomous or poisonous, a creature is currently poisoned, if a plant is poisonous or any food is poisoned. In addition, you may use Senses instead of Subterfuge when casting a [Poison] + [Spell] ability.", null, null),
        new Rank(2, "Toxic", "You are immune to all adverse effects from [Poison] abilities. In addition, you learn an augment that can be used on any [Poison] + [Spell] ability you cast.", null, augmentSetMephiteToxic),
        new Rank(3, "Snakeblood", "When you stagger a target, the stagger condition lasts 1 more turn and the penalty to successes is increased by 1. If you cause a creature to have the staggered condition for at least the next 5 turns, the staggered condition ends and the target is paralyzed until the end of its next turn. In addition, creatures must spend 1 more point of resolve to remove any adverse effect you cause.", null, null),
    ],
    "[Poison]");

export const specializationWanderer: RankOption = new RankOption("Wanderer", specializationCategory,
    [
        new Rank(1, "Well Traveled", "While traveling outside of a town or city, you cannot be ambushed or surprised. You gain +2 to movement speed. You ignore movement penalties.", null, null),
        new Rank(2, "Well Versed", "You can read and understand any language. You can communicate with beasts and plant-like creatures. It costs 1 less experience to raise your skills.", null, null),
        new Rank(3, "Well Rested", "Regardless of your sleeping conditions, you always benefit from a full rest when resting. In addition, after you gain the benefits of a full rest, all of your attributes are considered to be 1 higher for 4 hours. (They can go over 5)", null, null),
    ],
    "Wanderer");
...
export const specializationRavager: RankOption = new RankOption("Ravager", specializationCategory,
    [
        new Rank(1, "Predator’s Instinct", "Predator beasts, (such as big cats, raptors or wolves), instinctively know you are king of the jungle. They will in general avoid attacking you. If for any reason you do fight, those beasts will either only attack you or never attack you unless there is no other option. You decide each animal’s decision.", null, null),
        new Rank(2, "Savage", "You are immune to bleed effects. You gain two new augments that can be applied to any [Brawl] abilities you use.", null, augmentSetRavagerSavage),
        new Rank(3, "Beast’s Fury", "Your [Brawl] abilities gain +1 augment slot and +3 potency. Your bleed effects deliver their effects immediately.", null, null),
    ],
    "Ravager");

export const specializationCarnage: RankOption = new RankOption("Carnage", specializationCategory,
    [
        new Rank(1, "Bloodlust", "Any time a creature within 30’ of you is bleeding, your lust for blood comes to the surface. You deal 3 extra damage and gain an automatic success on all attacks.", null, null),
        new Rank(2, "Shred", "Your Bleed augment now also reduces a target’s soak by 1 per application and while the bleed is active, the target receives half healing from all sources. In addition, the effects of Bleed are doubled against a target with no soak.", null, null),
        new Rank(3, "Death Incarnate", "Once per round when you take damage you may perform a [Basic] ability for no AP cost immediately. In addition, you gain +2 HP.", null, null),
    ],
    "Carnage");
...
export const specializationBotanist: RankOption = new RankOption("Botanist", specializationCategory,
    [
        ...
        new Rank(2, "Potent Brews", "All potions you brew have their duration doubled, and all splash potions you brew extend a further 5’ in each direction. Additionally, all oils you brew have double the amount of applications available", null, null),
        new Rank(3, "Master Botanist", "Whenever you make a brew, you create a second identical brew for no additional cost. Additionally, you get +2 dice to all rolls made to brew.", null, null),
    ],
    "[Brewing]");
...
export const specializationRejuvenation: RankOption = new RankOption("Rejuvenation", specializationCategory,
    [
        new Rank(1, "Status", "You know the total health of all friendly creatures within 30’. You also know if they are affected by any adverse effects (such as charmed, poisoned, etc.) If you gain Status again, the range increases to 60’ and affects all creatures. In addition, you may use Senses instead of Presence when casting a [Heal] + [Spell] ability.", null, null),
        new Rank(2, "Nature’s Gift", "You are immune to poison and disease. In addition, you learn an augment that can be used on any [Heal] ability you cast.", null, augmentSetRejuvenationNature_sGift),
        new Rank(3, "Tend the Garden", "When you perform a [Heal] ability, you may target an additional creature. Additionally, your [Heal] abilities gain +1 augment slot. Finally, you do not need to spend AP the first time you maintain the Renew augment.", null, null),
    ],
    "[Heal]");

export const specializationAll_seeingEye: RankOption = new RankOption("All-Seeing Eye", specializationCategory,
    [
        new Rank(1, "Telepathy", "You can generate a mental link with a number of willing creatures equal to 5 plus your ranks in insight. While you have this mental link, you and the creature can communicate back and forth using just your thoughts. There is no limit on distance as long as you are on the same plane of existence.", null, null),
        new Rank(2, "Truesight", "Nothing can hide from you. Within 60’ you can see invisible creatures as if they were visible, and illusions appear translucent. If you already have Truesight, the range is increased to be unlimited.", null, null),
        new Rank(3, "Mentalist", "Your telepathy works even on different planes now. In addition, you can allow group communication between the different creatures you are linked with and yourself. Finally, the difficulty of all perception and insight rolls are reduced by 1.", null, null),
    ],
    "All-Seeing Eye");

export const specializationPrivateEye: RankOption = new RankOption("Private Eye", specializationCategory,
    [
        new Rank(1, "Human Lie Detector", "You always know when someone is lying.", null, null),
        new Rank(2, "Investigator", "The difficulty of all investigation checks are reduced by 2", null, null),
        new Rank(3, "See the Scene", "[Ritual] If you spend 1 hour investigating a specific area, you may instantly view the last 24 hours in this location (such a room or small section outdoors). This info is presented as if you were there while it is happening. (You don’t need to ‘watch’ all 24 hours, you know of all things that happened during the time period.", null, null),
    ],
    "Private Eye");

export const specializationThirdEye: RankOption = new RankOption("Third Eye", specializationCategory,
    [
        new Rank(1, "Omniscient", "You can see through the eyes of all creatures you are linked with at all times, as well as through your own. In addition, you may perform any action that doesn’t require a physical body to do, (such as mental powers or casting a spell), as if it originated from a creature that is linked to you. (For example, you could cast any [Spell] ability as if you were one of your linked creatures, but you could not attack with a weapon or move) You have a blindsense out to 30’. This allows you to always know the presence of all creatures in range. See the Scene now only takes a minute of investigating, rather than an hour.", null, null),
        new Rank(2, "Auspex", "You can talk to any creature within 30’ telepathically. You choose whether the creature can respond to you mentally or not. You may read the thoughts of any creature within 30’. Surface thoughts require no effort, but digging deep to get specific information may require an intellect + insight roll, difficulty 7. You can read the aura of any creature within 30’. This allows you to learn their mood.", null, null),
        new Rank(3, "Enlightened", "You gain +5 to initiative. When determining initiative order, if subtracting 10 from your initiative leaves you with a positive integer, you may also act on that initiative. Repeat this process until subtracting 10 no longer leaves you with a positive integer. Regardless of your total initiative, you may not take more than 3 turns in a single round. Spending AP to increase your initiative reduces your total AP for every turn you take on the first round.", null, null),
    ],
    "Third Eye");
...
export const specializationSoulShaper: RankOption = new RankOption("Soul Shaper", specializationCategory,
    [
        new Rank(1, "Mind Healing", "When you perform [Heal] abilities, you may roll using Intellect + Discipline instead of the normal pairing. If you choose to do so, the ability loses the [Spell] tag. You can sense when creatures near you are struggling with an issue.", null, null),
        new Rank(2, "Life Weaver", "You gain a few new augments that can only be applied to [Heal]  abilities.", null, augmentSetSoulShaperLifeWeaver),
        new Rank(3, "Vital Flow", "All creatures affected by your [Heal] abilities gain +1 AP for a number of turns equal to successes on the roll. In addition, anytime you remove exhaustion from a creature, remove a curse effect from a creature or cause a creature to regain resolve, the same effect applies to you.", null, null),
    ],
    "[Heal]");
...
export const specializationPsychic: RankOption = new RankOption("Psychic", specializationCategory,
    [
        new Rank(1, "Mental Recharge", "Whenever you spend a point of resolve, you regain 5 health. This does not count as a heal. 2: Know-it-all - You learn a number of augments that can be applied to any [Psychic] abilities you use.", null, augmentSetPsychicMentalRecharge),
        new Rank(2, "Psion", "All of your [Psychic] abilities gain +1 augment slot and deal 3 extra damage. You gain +1 maximum resolve.", null, null),
    ],
    "[Psychic]");
...
export const specializationOutsider: RankOption = new RankOption("Outsider", specializationCategory,
    [
        new Rank(1, "Vampiric Recharge", "Once per encounter, if you bring a creature to 0 health dealing psychic damage, you may regain 1 resolve.", null, null),
        new Rank(2, "Addle", "You are immune to the confused condition. In addition, you gain an augment that you can apply to any [Psychic] abilities you cast.", null, augmentSetOutsiderAddle),
        new Rank(3, "Master of Madness", "Whenever a creature within 120’ of you rolls a d10 for confusion, subtract 2 from the result. If the result would be 0 or less, you can choose what effect happens. In addition, creatures that are confused from an effect you caused take 5 unsoakable psychic damage at the start of their turn.The difficulty of all of your abilities with the [Psychic] tag are decreased by 1.", null, null),
    ],
    "[Psychic]");
...
export const specializationKiSage: RankOption = new RankOption("Ki Sage", specializationCategory,
    [
        new Rank(1, "Connected Soul", "You can understand all written and spoken languages. If you have 3 ranks in animal handling, you can understand and speak to animals.", null, null),
        new Rank(2, "Mystic Mage", "Your [Ki] + [Force] abilities can use augments as if they had the [Spell] tag. In addition, your [Ki] + [Force] abilities gain the tag of any damage type you have at least 2 total ranks in any combination of specializations tagged with that damage type. You also gain a few new augments that can be applied to any [Ki] + [Force] abilities.", null, augmentSetKiSageMysticMage),
        new Rank(3, "Close Your Eyes", "All of your [Ki] + [Force] abilities gain +1 augment slot. You gain a new augment that can only be applied to Meditate and Centered.", null, augmentSetKiSageCloseYourEyes),
    ],
    "[Ki]");
...
export const specializationAdept: RankOption = new RankOption("Adept", specializationCategory,
    [
        new Rank(1, "Lethal Hands", "Unarmed attacks lose the nonlethal property. Weapons with the Full-body trait deal +2 damage.", null, null),
        new Rank(2, "Secret Seals", "Unlock the Seals gains +1 augment slot for you. In addition, you gain a few new augments that can only be applied to Unlock the Seals.", null, augmentSetAdeptSecretSeals),
        new Rank(3, "Just Breathe", "Meditate and Centered cost 2 less AP to use. You gain a new augment that can only be applied to Meditate and Centered.", null, augmentSetAdeptJustBreathe),
    ],
    "[Ki]");
...
export const specializationTranquil: RankOption = new RankOption("Tranquil", specializationCategory,
    [
        new Rank(1, "Tranquility", "Meditate and Centered gain +1 augment slot. You gain a couple new augments that can only be applied to Meditate and Centered.", null, augmentSetTranquilTranquility),
        new Rank(2, "Center Yourself", "All of your [Ki] abilities have +5 potency. When you use Unlock the Seals, you may choose to also affect all creatures of your choice within 30’. Creatures cannot be forced to activate the Final Seal.", null, null),
        new Rank(3, "Peace", "You gain +2 to your movement speed. You gain a teleport speed that is equal to your movement speed. You gain +2 AP each round that can only be used on [Out-of-Turn] abilities. You gain +1 health multiplier.", null, null),
    ],
    "[Ki]");

export const specializationShade: RankOption = new RankOption("Shade", specializationCategory,
    [
        new Rank(1, "Obfuscation", "You no longer need to be obscured in any way to attempt to hide. Instead, you cloud the minds of those around you. Their mind begins to trick itself to prove that you aren’t there. You can still be heard, smelt and ran into. This doesn’t work if a creature is currently looking at you.", null, null),
        new Rank(2, "Shade Strike", "You can hide for no AP cost. After using any ability with the [Skulker] tag your next attack gains penetrating and +2 potency.", null, null),
        new Rank(3, "Master of the Pale", "Once per turn, you can attempt to hide even if creatures know where you are. You essentially wipe their mind of memory of your location. Once the memory is gone, you disappear from their vision. They don’t forget about you, they just can’t see you, so they can still look for you. All of your abilities gain the [Skulker] tag.", null, null),
    ],
    "[Skulker]");
...
export const specializationMystic: RankOption = new RankOption("Mystic", specializationCategory,
    [
        ...
        new Rank(2, "Prophecy Savant", "The difficulty of all prophecy crafting is reduced by 2 for you", null, null),
        new Rank(3, "Prophecy Master", "All prophecy crafting you do requires half the gold and time. In addition, the difficulty of all prophecy crafting you do is reduced by 1. You may wear and benefit from up to two charms", null, null),
    ],
    "[Prophecy]");
...
export const specializationMentalManipulation: RankOption = new RankOption("Mental Manipulation", specializationCategory,
    [
        new Rank(1, "Impose Your Will", "Anytime you spend resolve to affect a deception, persuasion, insight or leadership roll, you gain two automatic successes instead of one and you may reroll and take either result. In addition, you may use Intellect instead of the listed Attribute for all [Enthrall] abilities.", null, null),
        new Rank(2, "Manipulator", "You gain a few augments that can be applied to any [Enthrall] abilities you perform.", null, augmentSetMentalManipulationManipulator),
        new Rank(3, "Deceive", "Your allies attacks no longer remove the enthralled condition from your [Enthrall] abilities. Your [Enthrall] abilities gain +1 augment slot. The difficulty of all [Enthrall] abilities are reduced by 1.", null, null),
    ],
    "[Enthrall]");
...
export const specializationChangeOfHeart: RankOption = new RankOption("Change of Heart", specializationCategory,
    [
        new Rank(1, "Friendly Face", "Your training in manipulating people's hearts makes you better at first impressions. Creatures you meet for the first time will generally regard you in a favorable light. A creature that would normally be hostile towards you may be willing to hear what you have to say.", null, null),
        new Rank(2, "Convincing", "You gain a few augments that can be applied to any [Enthrall] abilities you perform.", null, augmentSetChangeOfHeartConvincing),
        new Rank(3, "Broken Heart", "When you use an [Enthrall] ability on a creature, you may force them to perform a [Basic] ability immediately against targets of your choice. Your [Enthrall] abilities gain +1 augment slot. In addition, you gain a new augment that can be applied to any ability you perform.", null, augmentSetChangeOfHeartBrokenHeart),
    ],
    "[Enthrall]");

export const specializationMerchant: RankOption = new RankOption("Merchant", specializationCategory,
    [
        new Rank(1, "I’ve Got a Guy", "For each rank in Merchant you have, gain two moderate contacts, as per the contacts background. In addition, all contacts you have from other sources are upgraded from minor to moderate.", null, null),
        new Rank(2, "Investment", "All of your contacts are upgraded to offer another service. On top of standard services, your contacts can also provide more advanced services, listed below. Fence - This contact is willing to buy and sell stolen goods Blackmarket Connections - This contact knows where to get the good stuff, whether the goods are illegal or just hard to come by. Safehouse - This contact has safehouses that you can stay at, which are discreet places to stay if you need to lay low. Dividends - Your investments with this contact have paid out. You gain 50 gold a day. There might be other advanced services available to you, as determined by the GM. You may spend 500g, to change one of the services of one of your contacts. This process takes 3 days before it takes effect.", null, null),
        new Rank(3, "Master Haggler", "Reduce the difficulty of all persuasion, intimidate and deception checks by 1. All of your contacts are upgraded to major contacts.", null, null),
    ],
    "Merchant");

export const specializationMinstrel: RankOption = new RankOption("Minstrel", specializationCategory,
    [
        new Rank(1, "Traveling Performer", "You may stay at any inn with free lodging and food. You may be required to perform for them. You may learn new perform types for only 2 experience.", null, null),
        new Rank(2, "Quick Learner", "[Song] abilities cost half the experience to purchase.", null, null),
        new Rank(3, "Inspiring Musician", "Reduce the difficulty of all perform rolls by 1. Friendly creatures affected by any of your [Song] abilities gain 1 automatic success on all rolls on their next turn.", null, null),
    ],
    "[Song]");
...
export const specializationBard: RankOption = new RankOption("Bard", specializationCategory,
    [
        ...
        new Rank(2, "Dedication", "You learn a few augments that can be applied to any [Song] abilities you perform.", null, augmentSetBardDedication),
        new Rank(3, "Virtuoso", "Your [Song] abilities cost 3 less AP (minimum of 1) and gain +1 augment slot.", null, null),
    ],
    "[Song]");

export const specializationSkald: RankOption = new RankOption("Skald", specializationCategory,
    [
        new Rank(1, "Inspiring Songs", "The difficulty of all presence rolls are reduced by 1 for you. All [Song] abilities you know gain the [Inspire] tag.", null, null),
        new Rank(2, "Morale", "Any creature that has temporary hit points from any effect you produce also benefits from +2 titan soak, +3 potency and +1 maximum AP.", null, null),
        new Rank(3, "True Leader", "You may use one [Inspire] ability once per turn for no AP cost. You gain 2 AP each turn you can spend to command your companions. Your abilities no longer count against the number of times [Out-of-Turn] actions can be taken per round.", null, null),
    ],
    "[Song, Inspire]");
...
export const specializationWarlord: RankOption = new RankOption("Warlord", specializationCategory,
    [
        ...
        new Rank(2, "Inspirational", "You gain a few augments that can only be applied to [Inspire] abilities.", null, augmentSetWarlordInspirational),
        new Rank(3, "Resolved", "The difficulty of all leadership rolls is reduced by 1. You gain +2 maximum resolve.", null, null),
    ],
    "[Inspire]");
...
export const specializationDiplomat: RankOption = new RankOption("Diplomat", specializationCategory,
    [
        new Rank(1, "Diplomatic Immunity", "Your status and skill as a diplomat can be used to your advantage. Most guards are willing to ignore minor crimes you commit, unless you make a habit of it. In addition, most officials will give you an audience upon request.", null, null),
        new Rank(2, "Booming Voice", "The range of all your [Inspire] abilities are increased by 30’. In addition, you gain a new augment that can be applied to any [Inspire] ability.", null, augmentSetDiplomatBoomingVoice),
        new Rank(3, "Fast Talker", "The AP cost of all [Inspire] abilities are reduced by 1 for you. The difficulty of all deception and persuasion rolls are reduced by 1 for you. All of your [Inspire] abilities gain +1 augment slot.", null, null),
    ],
    "[Inspire]");
